...
import inspect
import logging
from typing import Any, Dict, List, Optional, Callable, Type, TypeVar, Set
from dataclasses import dataclass, asdict
from datetime import datetime, timezone
from uuid import uuid4, UUID
from enum import Enum

from .kafka_client import get_kafka_client, KafkaClient
...
class EventBus:
    ...
    async def _start_consumer(self, consumer_group: str, event_type: str) -> None:
        ...
        try:
            ...
            topics = ["domain-events-characters", "domain-events-stories", 
                     "domain-events-campaigns", "domain-events-interactions"]
