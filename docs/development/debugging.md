...
def setup_debug_logging():
    ...
    loggers = {
        ...
        "src.core.types.shared_types": logging.WARNING  # Reduce schema noise
    }
...
from src.core.types.shared_types import WorldState, PersonaCardV2
...
poetry run python -c "
try:
    from src.core.types.shared_types import WorldState
    from src.engine.director import DirectorAgent
