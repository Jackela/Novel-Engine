...
## Purpose
Define a consistent, documented configuration surface for dashboard runtime settings.

## Requirements

### Standardized dashboard environment variables
...
### Legacy environment variable prefix removal
...
### Vite proxy configuration for SSE
