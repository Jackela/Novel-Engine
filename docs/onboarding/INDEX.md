...
Onboarding guides and resources for new team members and contributors to Novel Engine.
...
3. [Runbooks](../runbooks/)
4. [Incident Response](../runbooks/incident-response.md)
...
**Maintained by**: Novel Engine Team  
**License**: MIT
