...
class SecureDeploymentManager:
    ...
    def setup_authentication_system(self, config: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            AuthenticationManager(database_path="data/api_server.db", jwt_secret=jwt_secret)
...
def main():
    ...
    parser.add_argument(
        "--validate-only", action="store_true", help="Only validate configuration without deploying"
    )
    parser.add_argument(
        "--generate-ssl",
        action="store_true",
