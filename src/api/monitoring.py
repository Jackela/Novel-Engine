...
class MetricsCollector:
    ...
    def end_request_timer(self, request_id: str, request_metrics: RequestMetrics):
        ...
        with self._lock:
            ...
            # Record metrics
            self.record_timer("request_duration", request_metrics.duration_ms, {
        ...
        with self._lock:
            ...
            return {
                ...
                "recent_requests": {
                    ...
                    "error_rate": (len([r for r in recent_requests if r.status_code >= 400]) / len(recent_requests) * 100) if recent_requests else 0
                },
...
class AlertManager:
    ...
    def check_alerts(self) -> List[Dict[str, Any]]:
        ...
        recent_requests = [
            r for r in self.metrics_collector.requests
        ...
        for rule in self.alert_rules:
            ...
            try:
                ...
                metric_value = self._calculate_metric_value(rule, summary, recent_requests)
                ...
                if self._should_trigger_alert(rule, metric_value):
                    ...
                    if alert_key not in self.active_alerts:
                        ...
                        logger.log(
                            logging.WARNING if rule.level == AlertLevel.WARNING else logging.ERROR,
    ...
    def _calculate_metric_value(self, rule: AlertRule, summary: Dict[str, Any], recent_requests: List[RequestMetrics]) -> float:
...
__all__ = [
    'MetricType', 'AlertLevel', 'Metric', 'RequestMetrics', 'AlertRule',
    'MetricsCollector', 'AlertManager', 'MonitoringMiddleware', 'setup_monitoring'
]