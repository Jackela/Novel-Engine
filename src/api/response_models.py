...
class APIResponse(BaseModel, Generic[T]):
    ...
    errors: Optional[List[Union[APIError, ValidationError]]] = Field(None, description="Multiple errors for validation")
...
class CharacterDetail(CharacterSummary):
    ...
    skills: Dict[str, float] = Field(default_factory=dict, description="Character skills")
    relationships: Dict[str, float] = Field(default_factory=dict, description="Character relationships")
    current_location: str = Field("", description="Current character location")
    inventory: List[str] = Field(default_factory=list, description="Character inventory")
...
class StoryGenerationSummary(BaseModel):
    ...
    progress: float = Field(..., ge=0, le=100, description="Generation progress percentage")
...
__all__ = [
    'ResponseStatus', 'APIErrorType', 'APIError', 'ValidationError',
    'APIMetadata', 'PaginationInfo', 'APIResponse', 'SuccessResponse',
    'ErrorResponse', 'ListResponse', 'HealthCheckData', 'CharacterSummary',
    'CharacterDetail', 'StoryGenerationSummary', 'InteractionSummary',
    'HealthCheckResponse', 'CharacterListResponse', 'CharacterResponse',
    'StoryGenerationResponse', 'InteractionListResponse'
]