...
class PersonaAgent:
    ...
    def update_internal_memory(self, new_log: Dict[str, Any]) -> None:
        ...
        if len(self.subjective_worldview["recent_events"]) > 50:
            self.subjective_worldview["recent_events"] = self.subjective_worldview["recent_events"][-25:]
...
def create_persona_agent(character_directory_path: str, event_bus: 'EventBus', agent_id: Optional[str] = None) -> PersonaAgent:
    """
