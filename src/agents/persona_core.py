...
class PersonaCore:
    ...
    def __init__(self, character_directory_path: str, event_bus: 'EventBus', agent_id: Optional[str] = None):
        ...
        self.identity = AgentIdentity(
            agent_id=agent_id or self._derive_agent_id_from_path(character_directory_path),
            ...
            character_sheet_path=str(Path(character_directory_path) / "character_sheet.md")
        )
    ...
    def get_agent_state(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "state": {
                ...
                "last_action": self.state.last_action_timestamp.isoformat() if self.state.last_action_timestamp else None
            },
    ...
    def cleanup(self) -> None:
        ...
        logger.info(f"PersonaCore cleanup completed for agent: {self.identity.agent_id}")