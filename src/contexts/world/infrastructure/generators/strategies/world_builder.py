"""World building strategy for generating world setting, locations, factions, and events."""
...
class WorldBuilderStrategy(WorldGenerationStrategy):
    """Strategy for building complete world entities."""

    def execute(self, request: WorldGenerationInput) -> WorldGenerationResult:
        ...
        try:
            ...
            log.info("World generation completed", total_entities=result.total_entities)
            return result
    ...
    def _load_system_prompt(self) -> str:
        ...
        return self._load_prompt("world_gen")
