...
class HoroscopeService:
    ...
    async def get_daily_fortune(
        self, sign: ZodiacSign, date: Optional[str] = None
    ) -> HoroscopeData:
        """
        获取每日运势
    ...
    async def get_weekly_fortune(
        self, sign: ZodiacSign, week: Optional[str] = None
    ) -> HoroscopeData:
        """
        获取每周运势
    ...
    async def get_monthly_fortune(
        self, sign: ZodiacSign, month: Optional[str] = None
    ) -> HoroscopeData:
        """
        获取每月运势
    ...
    async def get_yearly_fortune(
        self, sign: ZodiacSign, year: Optional[str] = None
    ) -> HoroscopeData:
        """
        获取每年运势
    ...
    async def _fetch_fortune(
        ...
        fortune = HoroscopeFortune(overall=85, love=80, career=88, wealth=82, health=90)
