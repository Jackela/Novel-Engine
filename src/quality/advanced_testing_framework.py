...
class TestFramework:
    ...
    async def run_comprehensive_tests(self, 
                                    ...
                                    parallel: bool = True) -> Dict[str, TestSuite]:
    ...
    async def _run_unit_tests(self) -> List[TestResult]:
        ...
        try:
            ...
            cmd = ["python", "-m", "pytest", "tests/", "-v", "--json-report", "--json-report-file=test_results.json"]
    ...
    for suite_name, suite in results.items():
        ...
        if suite.benchmarks:
            ...
            for benchmark in suite.benchmarks:
                ...
                logger.info(f"  {benchmark.name}: {benchmark.current_time*1000:.2f}ms "
