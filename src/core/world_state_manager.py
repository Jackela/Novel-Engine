...
class WorldStateManager:
    ...
    def prepare_world_state_for_agent(self, agent_id: str, current_turn: int, 
        ...
        return {
            ...
            'environmental_updates': self._get_environmental_updates_for_agent(agent_id)
        }
    ...
    def _get_environmental_updates_for_agent(self, agent_id: str) -> Dict[str, Any]:
        ...
        return {
            'weather': self.world_state_data.get('environmental_state', {}).get('weather', 'stable'),
            'global_events': self.world_state_data.get('environmental_state', {}).get('global_events', [])
        }
    ...
    def generate_world_state_feedback(self, agent_id: str) -> Optional[Dict[str, Any]]:
        ...
        feedback = {
            ...
            'other_agents_activities': self._get_other_agents_activities_feedback(agent_id)
        }
    ...
    def get_world_state_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'global_threat_level': self.world_state_data.get('environmental_state', {}).get('threat_level', 'unknown'),
            'active_global_events': len(self.world_state_data.get('environmental_state', {}).get('global_events', []))
        }
