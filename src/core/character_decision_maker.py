...
from src.shared_types import CharacterAction, ActionPriority
...
class DecisionMaker:
    ...
    def make_decision(self, world_state_update: Dict[str, Any],
                     character_data: Dict[str, Any],
                     personality_traits: Dict[str, float],
                     decision_weights: Dict[str, float],
                     subjective_worldview: Dict[str, Any]) -> Optional[CharacterAction]:
        """
        ...
        for action in available_actions:
            score = self._evaluate_action_option(
                action, situation_assessment, personality_traits, 
    ...
    def _assess_current_situation(self, world_state_update: Dict[str, Any],
                                 character_data: Dict[str, Any],
                                 subjective_worldview: Dict[str, Any]) -> Dict[str, Any]:
        """Assess the current situation for decision-making."""
        assessment = {
            'threat_level': self._assess_overall_threat_level(world_state_update, subjective_worldview),
            'current_goals': self._get_current_goals(character_data, subjective_worldview),
            'available_resources': self._assess_available_resources(character_data, subjective_worldview),
        ...
        logger.debug(f"Agent {self.agent_id} situation assessment: {assessment['threat_level']}")
        return assessment
    
    def _identify_available_actions(self, situation_assessment: Dict[str, Any],
                                   character_data: Dict[str, Any],
                                   subjective_worldview: Dict[str, Any]) -> List[Dict[str, Any]]:
        """Identify actions available to the character in current situation."""
        available_actions = []
        
        # Basic actions always available
        basic_actions = [
            {'type': 'observe', 'description': 'Observe surroundings and gather information'},
        ...
        if known_entities:
            social_actions = [
                {'type': 'communicate', 'description': 'Attempt communication with nearby entities'},
    ...
    def _evaluate_action_option(self, action: Dict[str, Any],
                               situation: Dict[str, Any],
                               personality_traits: Dict[str, float],
                               decision_weights: Dict[str, float],
                               subjective_worldview: Dict[str, Any]) -> float:
    ...
    def _select_best_action(self, action_evaluations: List[Tuple[Dict[str, Any], float]],
                           character_data: Dict[str, Any]) -> Optional[CharacterAction]:
        ...
        if best_score < action_threshold:
            logger.debug(f"Agent {self.agent_id} best action score {best_score:.2f} below threshold {action_threshold:.2f}")
            return None
    ...
    def _assess_overall_threat_level(self, world_state_update: Dict[str, Any],
                                   subjective_worldview: Dict[str, Any]) -> ThreatLevel:
        ...
        for event in recent_events:
            ...
            if any(keyword in event_description for keyword in ['threat', 'danger', 'attack', 'hostile']):
                threat_indicators += 1
        
        # Check subjective worldview for threats
        known_entities = subjective_worldview.get('known_entities', {})
        hostile_entities = sum(1 for entity_data in known_entities.values() 
    ...
    def _get_current_goals(self, character_data: Dict[str, Any],
                          subjective_worldview: Dict[str, Any]) -> List[Dict[str, Any]]:
        ...
        if mission_data:
            goals.append({
                'type': 'mission',
                'description': mission_data.get('description', 'Complete current mission'),
                'priority': 'high'
            })
        ...
        # Personal goals
        personal_motivations = character_data.get('psychological', {}).get('motivations', {})
    ...
    def _assess_available_resources(self, character_data: Dict[str, Any],
                                   subjective_worldview: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _assess_social_obligations(self, subjective_worldview: Dict[str, Any]) -> List[Dict[str, Any]]:
    ...
    def _assess_mission_status(self, subjective_worldview: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _assess_environmental_factors(self, world_state_update: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _get_profession_actions(self, character_data: Dict[str, Any]) -> List[Dict[str, Any]]:
    ...
    def _apply_personality_modifiers(self, base_score: float, action_type: str,
    ...
    def _apply_situational_modifiers(self, base_score: float, action: Dict[str, Any],
                                   situation: Dict[str, Any], 
                                   decision_weights: Dict[str, float]) -> float:
    ...
    def _apply_profession_modifiers(self, base_score: float, action_type: str,
                                  subjective_worldview: Dict[str, Any]) -> float:
    ...
    def _get_character_action_threshold(self, character_data: Dict[str, Any]) -> float:
        ...
        decisiveness = character_data.get('psychological', {}).get('traits', {}).get('decisive', 0.5)
