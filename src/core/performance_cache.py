...
class MemoryCache(CacheBackend):
    ...
    async def set(self, key: str, value: Any, ttl: Optional[float] = None, 
                  level: CacheLevel = CacheLevel.MEDIUM) -> bool:
    ...
    async def _ensure_space(self, required_memory: int, level: CacheLevel):
        ...
        # Check memory limit
        while (self.memory_usage + required_memory > self.max_memory_bytes or 
...
class PerformanceCache:
    ...
    async def set_character(self, character_id: str, character_data: Dict[str, Any], 
                           ttl: Optional[float] = 3600) -> bool:
    ...
    async def get_story_generation(self, generation_id: str) -> Optional[Dict[str, Any]]:
    ...
    async def set_story_generation(self, generation_id: str, generation_data: Dict[str, Any],
                                  ttl: Optional[float] = 7200) -> bool:
    ...
    async def set_template(self, template_key: str, template_content: str,
    ...
    async def get_comprehensive_stats(self) -> Dict[str, Any]:
        ...
        char_total = self.cache_stats['character_hits'] + self.cache_stats['character_misses']
        story_total = self.cache_stats['story_hits'] + self.cache_stats['story_misses']
        template_total = self.cache_stats['template_hits'] + self.cache_stats['template_misses']
        ...
        return {
            ...
            'domain_stats': {
                ...
                'template': {
                    ...
                    'hit_rate': self.cache_stats['template_hits'] / max(template_total, 1)
                }
            }
        }
...
__all__ = [
    ...
    'get_global_cache', 'close_global_cache'
]