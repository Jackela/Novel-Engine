...
class EventRegistry:
    ...
    def _initialize_schemas(self):
        ...
        self.register_schema(EventSchema(
            ...
            payload_schema={
                "character_id": {"type": "string", "description": "Unique character identifier"},
                "character_name": {"type": "string", "description": "Character display name"},
                "character_archetype": {"type": "string", "description": "Character archetype"},
                "traits": {"type": "object", "description": "Character traits"},
                "metadata": {"type": "object", "description": "Additional character metadata"}
            },
            examples=[{
        ...
        self.register_schema(EventSchema(
            ...
            payload_schema={
                ...
                "memory_type": {"type": "string", "enum": ["working", "episodic", "semantic", "emotional", "relationship"]},
                "content": {"type": "string"},
                "emotional_weight": {"type": "number", "minimum": -10, "maximum": 10},
        ...
        self.register_schema(EventSchema(
            ...
            payload_schema={
                ...
                "interaction_type": {"type": "string", "enum": ["dialogue", "combat", "trade", "exploration"]},
        ...
        self.register_schema(EventSchema(
            ...
            examples=[{
                ...
                "components": ["orchestrator", "memory_system", "interaction_engine"]
            }]
        ))
    ...
    def validate_event_payload(self, event_type: EventType, payload: Dict[str, Any]) -> bool:
        """
    ...
    def get_schema_documentation(self, event_type: EventType) -> Optional[Dict[str, Any]]:
