"""Types and data structures for Enhanced Multi-Agent Bridge.

This module contains all type definitions, enums, dataclasses, and protocols
used by the enhanced multi-agent bridge system.
"""
