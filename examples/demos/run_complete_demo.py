...
class CompleteDemoRunner:
    ...
    async def _initialize_system(self):
        ...
        if startup_result.success:
            ...
            error_msg = (
                startup_result.error.message if startup_result.error else "Unknown startup error"
            )
    ...
    async def _demonstrate_story_1_character_creation(self):
        ...
        for char_data in characters_data:
            ...
            emotional_state = EmotionalState(
                current_mood=7, dominant_emotion="focused", energy_level=8, stress_level=3
            )
    ...
    async def _cleanup_system(self):
        ...
        if self.orchestrator:
            ...
            if shutdown_result.success:
                ...
                warning_msg = (
                    shutdown_result.error.message if shutdown_result.error else "Unknown warning"
                )
