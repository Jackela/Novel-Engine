...
- [ ] 4.3 Add whole-book tests proving capacity refusal stops the loop, preserves
      earlier accepted chapters, and starts no later chapter.
- [ ] 4.4 Regenerate OpenAPI and frontend types and pass drift/CORS/error-catalog
