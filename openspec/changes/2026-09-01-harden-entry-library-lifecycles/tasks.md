...
- [x] 1. Add red component tests for operational library failure, Retry,
      unmount cancellation, stale completion, and duplicate mutations.
- [x] 2. Implement owned entry and library bootstrap requests with classified
