...
- [x] 1. Add failing tests for pre-response and total stream deadlines,
      mid-body transport failure, and effective chapter timeout.
- [x] 2. Add failing tests for synchronous body, total SSE, individual event,
      mixed newline boundaries, explicit external cancellation, and Unicode
