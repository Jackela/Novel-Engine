...
- **Contract-First Experience APIs**: Produce OpenAPI fragment `contracts/openapi-refactor.yaml` documenting rate limits, idempotency keys, pagination for `/api/campaigns`, `/api/simulations`. No new endpoints, but existing contracts updated.  
