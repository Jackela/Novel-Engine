            ...
            "panels": [
                {
                    ...
                    "targets": [
                        {"expr": "novel_engine_active_users", "legendFormat": "Active Users"}
                    ],
                    "fieldConfig": {
                        "defaults": {
                            "unit": "short",
        ...
        "dashboard": {
            ...
            "panels": [
                ...
                },
                {
                    ...
                    "type": "table",
                    "gridPos": {"h": 8, "w": 12, "x": 12, "y": 0},
                    "targets": [{"expr": "novel_engine_security_events", "format": "table"}],
                },
            ],
        }
    }
            ...
            "panels": [
                {
                    ...
                    "targets": [{"expr": 'up{job=~"novel-engine.*"}', "legendFormat": "{{job}}"}],
                    "fieldConfig": {
                        "defaults": {
                            "mappings": [
                                {
