...
def configure_logging(
    environment: str = "production", log_level: str = "INFO"
) -> Dict[str, Any]:
    """
...
def create_logger(
    name: str, extra_fields: Optional[Dict[str, Any]] = None
) -> logging.Logger:
    """
    ...
    logger.info_structured = lambda msg, **kwargs: log_with_extra(
        logging.INFO, msg, **kwargs
    )
    logger.warning_structured = lambda msg, **kwargs: log_with_extra(
        logging.WARNING, msg, **kwargs
    )
    logger.error_structured = lambda msg, **kwargs: log_with_extra(
        logging.ERROR, msg, **kwargs
    )
    logger.debug_structured = lambda msg, **kwargs: log_with_extra(
