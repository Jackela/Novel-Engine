...
class DashboardDataCollector:
    ...
    def get_metric_data(self, metric_name: str, time_range: str = "1h") -> Optional[TimeSeriesData]:
        ...
        filtered_points = [point for point in series.data_points if point.timestamp >= cutoff_time]

        return TimeSeriesData(
            metric_name=metric_name, data_points=filtered_points, aggregation_window=time_range
        )
    ...
    def get_system_overview(self) -> Dict[str, Any]:
        ...
        overview = {"timestamp": current_time.isoformat(), "metrics": {}, "status": "healthy"}
