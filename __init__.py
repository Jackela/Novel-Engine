...
Top-level package exports for the Novel Engine with modular refactored
architecture.

This package maintains backward compatibility while providing access to the
new modular component architecture implemented in Wave 4 refactoring.
...
__description__ = (
    "Advanced AI Narrative Generation Platform with Modular Architecture"
)
...
# Export the core classes to prevent F401 warnings
...
try:
    ...
    DirectorAgentIntegrated = None
    PersonaAgentIntegrated = None
...
try:
    ...
    CharacterInterpreter = None
    DecisionEngine = None
    DirectorAgentBase = None
    MemoryInterface = None
    PersonaAgentCore = None
    TurnOrchestrator = None
    WorldStateCoordinator = None
    MODULAR_COMPONENTS = []
...
if INTEGRATED_AVAILABLE:
    ADVANCED_EXPORTS.extend(
        ["DirectorAgentIntegrated", "PersonaAgentIntegrated"]
    )
