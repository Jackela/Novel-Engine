...
describe('PerformanceMetrics RBAC', () => {
  ...
  beforeEach(() => {
    ...
    (import.meta.env as any).VITE_SHOW_PERFORMANCE_METRICS = 'true';
  });

  afterEach(() => {
    // Restore original env
    (import.meta.env as any).VITE_SHOW_PERFORMANCE_METRICS = originalEnv;
  });
  ...
  it('hidden when env var is not set', () => {
    (import.meta.env as any).VITE_SHOW_PERFORMANCE_METRICS = 'false';
  ...
  it('hidden when env var is undefined', () => {
    delete (import.meta.env as any).VITE_SHOW_PERFORMANCE_METRICS;
