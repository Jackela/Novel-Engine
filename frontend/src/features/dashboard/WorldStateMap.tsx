...
const LocationMarker = styled(motion.button, {
  ...
  backgroundColor: active ? 'rgba(0, 240, 255, 0.15)' : theme.palette.background.paper,
  textAlign: 'left',
  '&:hover': {
    background: active ? 'rgba(0, 240, 255, 0.3)' : 'var(--color-bg-tertiary)',
          ...
          {locations.map((location, index) => {
            ...
            return (
              <LocationMarker
                ...
                onClick={() => setSelectedLocation(prev => prev === location.id ? null : location.id)}
