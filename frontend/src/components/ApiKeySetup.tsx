 ...
 */
type ApiConfiguredInfo = {
  hasApiKey: boolean;
  model?: string;
  mode?: 'demo' | 'user';
  source: 'user_configured' | 'user_skipped';
};

interface ApiKeySetupProps {
  onConfigured?: (info: ApiConfiguredInfo) => void;
  allowSkip?: boolean;
}

function ApiKeySetup({ onConfigured, allowSkip = true }: ApiKeySetupProps) {
