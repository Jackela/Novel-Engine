...
const createTestStore = (preloadedState?: Partial<DecisionState>) => {
...
describe('decisionSlice initial state', () => {
...
describe('decisionSlice setDecisionPoint', () => {
...
describe('decisionSlice clearDecisionPoint', () => {
...
describe('decisionSlice selectOption', () => {
...
describe('decisionSlice setFreeTextInput', () => {
...
describe('decisionSlice decrementCountdown', () => {
...
describe('decisionSlice setNegotiationResult', () => {
  ...
  it('updates pause state to negotiating', () => {
    const result = {
      ...
      adjustedAction: null,
      alternatives: [{ optionId: 10, label: 'Alt 1', description: 'Alternative' }],
    };
...
describe('decisionSlice clearError', () => {
...
describe('decisionSlice pause state transitions', () => {
...
describe('decisionSlice decision history', () => {
