...
export const enStudio = {
  ...
  "lore.input.heading": "Draft material",
  "lore.input.paste": "Paste a draft segment",
  "lore.input.pasteLabel": "Pasted text",
  "lore.input.action.extract": "Extract segment",
  "lore.input.documents": "Imported chapter",
  "lore.input.documentsChoose": "Choose a chapter…",
  "lore.input.action.extractDocument": "Extract chapter",
  "lore.input.documentsNone": "No chapter documents yet — paste draft text above.",
  "lore.segments.heading": "Extraction segments",
  "lore.segment.status.running": "Extracting…",
  "lore.segment.status.completed": "{count} suggestions",
  "lore.segment.status.failed": "Extraction failed",
  "lore.segment.action.retry": "Retry segment",
  "lore.candidates.heading": "Suggested lore entries",
  "lore.candidates.hint": "Suggestions stay in this session — nothing is saved until you confirm.",
  "lore.candidates.kind.character": "Character",
  "lore.candidates.kind.world": "World",
  "lore.candidates.field.aliases": "Aliases (comma-separated)",
  "lore.candidates.summary": "Summary",
  ...
  "lore.results.failed": "Failed",
  "lore.results.retryHint": "Aliases kept for retry: {aliases}",
  "lore.results.action.retryAliases": "Retry alias write",
  "lore.results.action.startOver": "Start over",
  "lore.error.extract": "Lore extraction failed.",
  "lore.error.confirm": "Creating the entry failed.",
  "lore.error.aliasWrite": "Writing aliases failed.",
