...
class TermCondition:
    ...
    def with_value(self, new_value: Union[str, int, float, Decimal, bool, Dict[str, Any]]) -> 'TermCondition':
    ...
    def __eq__(self, other: Any) -> bool:
        ...
        return (
            ...
            self.is_negotiable == other.is_negotiable and
...
class ProposalTerms:
    ...
    @classmethod
    def create(cls, proposal_type: ProposalType, title: str, summary: str,
               terms: List[TermCondition], validity_period: Optional[datetime] = None,
               metadata: Optional[Dict[str, Any]] = None) -> 'ProposalTerms':
    ...
    def __eq__(self, other: Any) -> bool:
        ...
        return (
            ...
            self.proposal_type == other.proposal_type and
            self.title == other.title and
            self.summary == other.summary and
            self.terms == other.terms and
            self.validity_period == other.validity_period and
