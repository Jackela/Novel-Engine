...
class NegotiationCapability:
    ...
    def __eq__(self, other: Any) -> bool:
        ...
        if not isinstance(other, NegotiationCapability):
            return False
        return (
            self.capability_name == other.capability_name and
            self.proficiency_level == other.proficiency_level and
            self.confidence_modifier == other.confidence_modifier and
            self.applicable_domains == other.applicable_domains and
...
class PartyPreferences:
    ...
    def __post_init__(self):
        ...
        if (self.preferred_session_duration and self.maximum_session_duration and 
            self.preferred_session_duration > self.maximum_session_duration):
    ...
    def is_compatible_with(self, other: 'PartyPreferences') -> bool:
        ...
        # Time compatibility
        if (self.maximum_session_duration and other.maximum_session_duration and
            min(self.maximum_session_duration, other.maximum_session_duration) < 30):
            return False  # Minimum viable session time
        
        # Language compatibility
        if (self.language_preferences and other.language_preferences and
            not self.language_preferences.intersection(other.language_preferences)):
            return False
    ...
    def __eq__(self, other: Any) -> bool:
        ...
        if not isinstance(other, PartyPreferences):
            return False
        return (
            self.negotiation_style == other.negotiation_style and
            self.communication_preference == other.communication_preference and
            self.risk_tolerance == other.risk_tolerance and
            self.time_pressure_sensitivity == other.time_pressure_sensitivity and
            self.preferred_session_duration == other.preferred_session_duration and
            self.maximum_session_duration == other.maximum_session_duration and
            self.cultural_considerations == other.cultural_considerations and
            self.taboo_topics == other.taboo_topics and
            self.preferred_meeting_times == other.preferred_meeting_times and
            self.language_preferences == other.language_preferences
        )
...
class NegotiationParty:
    ...
    def __post_init__(self):
        ...
        if self.role == PartyRole.ADVISOR and self.authority_level not in [
            AuthorityLevel.ADVISORY_ONLY, AuthorityLevel.OBSERVER_ONLY
        ]:
    ...
    def __eq__(self, other: Any) -> bool:
        ...
        if not isinstance(other, NegotiationParty):
            return False
        return (
            self.party_id == other.party_id and
            self.entity_id == other.entity_id and
            self.party_name == other.party_name and
            self.role == other.role and
            self.authority_level == other.authority_level and
            self.capabilities == other.capabilities and
            self.preferences == other.preferences and
            self.constraints == other.constraints and
            self.reputation_modifiers == other.reputation_modifiers and
            self.active_mandates == other.active_mandates
        )
