...
from ...infrastructure.repositories.narrative_arc_repository import NarrativeArcRepository
...
class NarrativeArcApplicationService:
    ...
    def get_plot_points_in_sequence(self,
                                  arc_id: str,
    ...
    def update_plot_point(self,
        ...
        command = UpdatePlotPointCommand(
            ...
            description=description,
            sequence_order=sequence_order,
            emotional_intensity=Decimal(str(emotional_intensity)) if emotional_intensity is not None else None,
            dramatic_tension=Decimal(str(dramatic_tension)) if dramatic_tension is not None else None,
            story_significance=Decimal(str(story_significance)) if story_significance is not None else None,
            outcome=outcome,
            notes=notes
        )
    ...
    def get_themes_at_sequence(self, arc_id: str, sequence: int) -> List[Dict[str, Any]]:
        ...
        query = GetThemesAtSequenceQuery(
            arc_id=arc_id,
            sequence=sequence
        )
    ...
    def develop_theme(self, arc_id: str, theme_id: str, sequence: int, development_notes: str = "") -> None:
    ...
    def add_narrative_context(self,
                            arc_id: str,
                            context_id: str,
                            context_type: str,
                            name: str,
    ...
    def analyze_narrative_flow(self,
                             arc_id: str,
                             include_recommendations: bool = True,
                             include_tension_progression: bool = True) -> Dict[str, Any]:
    ...
    def optimize_sequence(self,
                         ...
                         optimization_criteria: Optional[List[str]] = None) -> Dict[str, Any]:
    ...
    def establish_causal_link(self,
                            arc_id: str,
                            cause_id: str,
                            effect_id: str,
    ...
    def analyze_causality(self,
                         ...
                         max_path_depth: int = 5) -> Dict[str, Any]:
    ...
    def get_arc_metrics(self,
                       arc_id: str,
                       include_coherence: bool = True,
                       include_flow_analysis: bool = False,
                       include_causal_analysis: bool = False) -> Dict[str, Any]:
    ...
    def get_arc_summary(self,
                       ...
                       include_progression: bool = True) -> Dict[str, Any]:
    ...
    def search_narrative_arcs(self,
