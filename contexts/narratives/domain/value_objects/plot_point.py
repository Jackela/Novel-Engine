...
class PlotPoint:
    ...
    def is_major_plot_point(self) -> bool:
        ...
        return self.importance in [PlotPointImportance.CRITICAL, PlotPointImportance.MAJOR]
    ...
    def with_updated_intensity(self,
                              emotional_intensity: Optional[Decimal] = None,
                              dramatic_tension: Optional[Decimal] = None,
                              story_significance: Optional[Decimal] = None) -> 'PlotPoint':
        """
