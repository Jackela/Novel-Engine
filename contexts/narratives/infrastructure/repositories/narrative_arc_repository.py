...
class NarrativeArcRepository(INarrativeArcRepository):
    ...
    def _create_arc_entity(self, narrative_arc: NarrativeArc) -> NarrativeArcEntity:
        ...
        arc_entity = NarrativeArcEntity(
            ...
            parent_arc_id=(
                narrative_arc.parent_arc_id.value if narrative_arc.parent_arc_id else None
            ),
    ...
    def _create_theme_entity(self, theme: NarrativeTheme, arc_id: UUID) -> NarrativeThemeEntity:
        ...
        return NarrativeThemeEntity(
            ...
            development_potential=theme.development_potential,
    ...
    def _create_pacing_entity(self, pacing: StoryPacing, arc_id: UUID) -> StoryPacingEntity:
        ...
        return StoryPacingEntity(
            ...
            tension_curve=[float(t) for t in pacing.tension_curve],
            dialogue_ratio=pacing.dialogue_ratio,
            action_ratio=pacing.action_ratio,
            reflection_ratio=pacing.reflection_ratio,
            description_density=pacing.description_density,
            character_focus=[str(cid) for cid in pacing.character_focus],
    ...
    def _entity_to_aggregate(self, arc_entity: NarrativeArcEntity) -> NarrativeArc:
        ...
        for plot_entity in arc_entity.plot_points:
            plot_point = PlotPoint(
                ...
                thematic_relevance={
                    k: Decimal(str(v)) for k, v in plot_entity.thematic_relevance.items()
                },
        ...
        narrative_arc = NarrativeArc(
            ...
            active_contexts=(
                set(arc_entity.active_contexts) if hasattr(arc_entity, "active_contexts") else set()
            ),
            primary_characters=(
            ...
            parent_arc_id=(
                NarrativeId(arc_entity.parent_arc_id) if arc_entity.parent_arc_id else None
            ),
