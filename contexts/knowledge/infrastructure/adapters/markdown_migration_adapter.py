...
from ..metrics_config import migration_entries_processed_total, migration_duration_seconds
import time
...
class MarkdownMigrationAdapter:
    ...
    def __init__(self, repository: IKnowledgeRepository):
        ...
        self._migration_metadata: Dict[str, Dict[str, Any]] = {}  # Track migration details
