...
class PerceptionRange:
    ...
    def apply_environmental_modifier(self, modifier_name: str, modifier_value: float) -> 'PerceptionRange':
...
class PerceptionCapabilities:
    ...
    def get_best_visibility_at_distance(self, distance: float, 
                                       focused_perception: Optional[PerceptionType] = None) -> VisibilityLevel:
