...
class KnowledgeItem:
    ...
    def with_updated_certainty(self, new_certainty: CertaintyLevel, 
                              new_source: Optional[KnowledgeSource] = None) -> 'KnowledgeItem':
...
class KnowledgeBase:
        ...
        for subject, items in self.knowledge_items.items():
            ...
            for item in items:
                ...
                if item.subject != subject:
                    raise ValueError(f"Knowledge item subject mismatch: expected '{subject}', got '{item.subject}'")
    
    def get_knowledge_about(self, subject: str, 
                           current_time: Optional[datetime] = None,
                           min_reliability: float = 0.0) -> List[KnowledgeItem]:
    ...
    def get_most_reliable_knowledge(self, subject: str,
                                   current_time: Optional[datetime] = None) -> Optional[KnowledgeItem]:
    ...
    def get_stale_knowledge(self, current_time: Optional[datetime] = None) -> Dict[str, List[KnowledgeItem]]:
