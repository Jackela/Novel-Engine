...
from ..value_objects.knowledge_level import KnowledgeType, CertaintyLevel, KnowledgeItem
...
class KnowledgeRevealed(SubjectiveDomainEvent):
    ...
    confidence_change: Optional[float] = None  # Change in confidence if updating existing knowledge
