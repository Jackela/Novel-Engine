...
class SubjectiveApplicationService:
    ...
    def lose_threat_tracking(
        self, entity_id: str, threat_subject: str, loss_reason: str = "unknown"
    ) -> None:
        """
        ...
        self.logger.info(
            f"Entity {entity_id} lost tracking of threat {threat_subject}: {loss_reason}"
        )

    # Bulk Operations

    def update_world_state_version_for_entities(
        self, entity_ids: List[str], new_world_state_version: int
    ) -> int:
        """
    ...
    def cleanup_stale_knowledge_for_entity(
        ...
        self.fog_of_war_service.filter_knowledge_by_reliability(
    ...
    def get_entities_that_can_perceive_location(
        ...
        """
        return self.repository.find_entities_in_perception_range_of_location(
            location_id, perception_type
        )
    ...
    def get_knowledge_sharing_candidates(
        ...
        """
        return self.repository.get_knowledge_sharing_candidates(
            entity_id, knowledge_type, max_distance
        )
