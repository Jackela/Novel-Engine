...
from ...domain.value_objects.perception_range import PerceptionType, PerceptionCapabilities
...
class UpdateAwarenessStateCommand(SubjectiveCommand):
    ...
    def validate(self) -> None:
        ...
        if (self.new_attention_focus == AttentionFocus.TARGET_SPECIFIC and 
            not self.new_focus_target):
