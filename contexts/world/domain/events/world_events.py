...
class WorldStateChanged(Event):
    ...
    def _validate_world_event(self) -> None:
        ...
        if self.change_type in [WorldChangeType.ENTITY_ADDED, WorldChangeType.ENTITY_REMOVED, 
                               WorldChangeType.ENTITY_MOVED, WorldChangeType.ENTITY_UPDATED]:
    ...
    @classmethod
    def entity_added(cls, entity_id: str, entity_type: str, entity_state: Dict[str, Any],
                     reason: Optional[str] = None, batch_id: Optional[str] = None,
                     source: str = "world_context") -> 'WorldStateChanged':
        """
    ...
    @classmethod
    def entity_removed(cls, entity_id: str, entity_type: str, previous_state: Dict[str, Any],
                      reason: Optional[str] = None, batch_id: Optional[str] = None,
                      source: str = "world_context") -> 'WorldStateChanged':
        """
    ...
    @classmethod
    def entity_moved(cls, entity_id: str, entity_type: str, 
                     previous_position: Dict[str, Any], new_position: Dict[str, Any],
                     reason: Optional[str] = None, batch_id: Optional[str] = None,
                     source: str = "world_context") -> 'WorldStateChanged':
        """
    ...
    @classmethod
    def entity_updated(cls, entity_id: str, entity_type: str,
                      previous_state: Optional[Dict[str, Any]] = None,
                      new_state: Optional[Dict[str, Any]] = None,
    ...
    @classmethod
    def state_snapshot(cls, snapshot_data: Dict[str, Any], reason: str,
                      source: str = "world_context") -> 'WorldStateChanged':
        """
    ...
    @classmethod
    def state_reset(cls, reason: str, previous_state: Optional[Dict[str, Any]] = None,
                   source: str = "world_context") -> 'WorldStateChanged':
        """
    ...
    @classmethod
    def environment_changed(cls, environment_changes: Dict[str, Any], reason: str,
    ...
    @classmethod
    def time_advanced(cls, previous_time: datetime, new_time: datetime, reason: str,
                     source: str = "world_context") -> 'WorldStateChanged':
        """
