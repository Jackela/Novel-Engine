...
class WorldState(Entity):
    ...
    def add_entity(self, entity_id: str, entity_type: EntityType, name: str,
                   coordinates: Coordinates, properties: Optional[Dict[str, Any]] = None,
                   metadata: Optional[Dict[str, Any]] = None) -> WorldEntity:
        """
    ...
    def move_entity(self, entity_id: str, new_coordinates: Coordinates,
    ...
    def update_entity(self, entity_id: str, properties: Optional[Dict[str, Any]] = None,
        ...
        self.raise_domain_event(
            WorldStateChanged.entity_updated(
                ...
                new_state={'properties': entity.properties, 'metadata': entity.metadata},
    ...
    def get_entities_in_area(self, center: Coordinates, radius: float,
                            entity_types: Optional[List[EntityType]] = None) -> List[WorldEntity]:
        """
    ...
    def get_entities_at_coordinates(self, coordinates: Coordinates, 
                                   tolerance: float = 0.0) -> List[WorldEntity]:
        """
    ...
    def update_environment(self, environment_changes: Dict[str, Any],
