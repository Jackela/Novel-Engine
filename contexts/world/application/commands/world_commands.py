    ...
    def __post_init__(self):
        ...
        if self.operation_type == WorldOperationType.ADD_ENTITY:
            if not all([self.entity_id, self.entity_type, self.entity_name, self.coordinates]):
                raise ValueError("ADD_ENTITY requires entity_id, entity_type, entity_name, and coordinates")
...
class ApplyWorldDelta:
    ...
    def _validate_command(self) -> None:
        ...
        if self.reset_operation and (self.entity_operations or self.environment_operation):
            errors.append("Reset operation cannot be combined with entity or environment operations")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'entity_operations': [
                {
                    ...
                    'new_coordinates': op.new_coordinates.to_dict() if op.new_coordinates else None,
            ...
            } if self.snapshot_operation else None,
            'reset_operation': {
            ...
            } if self.reset_operation else None,
    ...
    @classmethod
    def create_entity_addition(cls, world_state_id: str, entity_id: str, 
                              entity_type: EntityType, entity_name: str,
                              coordinates: Coordinates, reason: str,
                              properties: Optional[Dict[str, Any]] = None,
                              metadata: Optional[Dict[str, Any]] = None,
                              user_id: Optional[str] = None) -> 'ApplyWorldDelta':
        """
    ...
    @classmethod
    def create_entity_removal(cls, world_state_id: str, entity_id: str, 
                             reason: str, user_id: Optional[str] = None) -> 'ApplyWorldDelta':
        """
    ...
    @classmethod
    def create_environment_update(cls, world_state_id: str, 
                                 environment_changes: Dict[str, Any],
                                 reason: str, user_id: Optional[str] = None,
                                 affected_area: Optional[Dict[str, Any]] = None) -> 'ApplyWorldDelta':
        """
    ...
    def __repr__(self) -> str:
        ...
        return (f"ApplyWorldDelta(command_id={self.command_id}, "
