...
def test_imports():
    ...
    try:
        ...
        from .use_cases.update_world_state_uc import UpdateWorldStateUC, UpdateWorldStateResult
        print("✅ Use case imports successful")
        
        # Test domain imports (to verify dependencies)
        from ..domain.aggregates.world_state import WorldState, EntityType
...
def test_command_creation():
    ...
    try:
        from .commands.world_commands import ApplyWorldDelta, EntityOperation, WorldOperationType
        ...
        command = ApplyWorldDelta(
            ...
            reason="Testing command creation"
        )
    ...
    try:
        ...
        class MockRepository(IWorldStateRepository):
            ...
            async def find_entities_by_type(self, world_state_id, entity_type, offset=0, limit=100):
                return []
            async def find_entities_in_area(self, world_state_id, center, radius, entity_types=None):
                return []
            async def find_entities_by_coordinates(self, world_state_id, coordinates, tolerance=0.0):
                return []
...
def test_clean_architecture_compliance():
    ...
    try:
        ...
        command = ApplyWorldDelta(
            world_state_id="test-world",
            reason="Architecture compliance test"
        )
        ...
        return False, f"Clean Architecture compliance error: {str(e)}\n{traceback.format_exc()}"
