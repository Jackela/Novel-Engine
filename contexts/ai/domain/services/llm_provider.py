...
from ..value_objects.common import ProviderId, ModelId, TokenBudget, ModelCapability
    ...
    def __post_init__(self):
        ...
        if self.max_tokens is not None:
            ...
            if self.max_tokens > self.model_id.max_output_tokens:
                raise ValueError(f"max_tokens ({self.max_tokens}) exceeds model limit ({self.model_id.max_output_tokens})")
...
class LLMResponse:
    ...
    def __post_init__(self):
        ...
        if self.usage_stats is None:
            object.__setattr__(self, 'usage_stats', {"input_tokens": 0, "output_tokens": 0, "total_tokens": 0})
    ...
    def is_successful(self) -> bool:
        ...
        return self.status in {LLMResponseStatus.SUCCESS, LLMResponseStatus.PARTIAL_SUCCESS}
...
class LLMProviderError(Exception):
    ...
    def __init__(self, message: str, provider_id: Optional[ProviderId] = None, 
