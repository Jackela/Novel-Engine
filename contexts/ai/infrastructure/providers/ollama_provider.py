...
class OllamaProvider(ILLMProvider):
    ...
    def __init__(
        ...
        self._provider_id = ProviderId(
            ...
            api_version="1.0.0",
            metadata={"base_url": self._base_url, "local": True},
        )
    ...
    def _parse_success_response(
        self, request: LLMRequest, response_data: Dict[str, Any]
    ) -> LLMResponse:
        """
    ...
    def _parse_error_response(
        self, request: LLMRequest, status_code: int, response_text: str
    ) -> LLMResponse:
        """
