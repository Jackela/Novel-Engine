...
from ...domain.value_objects.character_profile import CharacterClass, CharacterRace, Gender
...
class CharacterApplicationService:
    ...
    async def damage_character(
        ...
        """
        self.logger.info(f"Applying {damage_amount} {damage_type} damage to character {character_id}")
    ...
    async def find_characters_by_level_range(self, min_level: int, max_level: int) -> List[Character]:
    ...
    async def create_multiple_characters(self, character_data_list: List[Dict[str, Any]]) -> List[CharacterID]:
