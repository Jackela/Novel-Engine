...
from ...domain.value_objects.character_profile import Gender, CharacterRace, CharacterClass
from ...domain.value_objects.character_stats import AbilityScore
from ...domain.value_objects.skills import SkillCategory, ProficiencyLevel
    ...
    def __post_init__(self):
        ...
        for ability, improvement in self.ability_score_improvements.items():
            ...
            if not 0 <= improvement <= 3:
                errors.append(f"Ability improvement must be 0-3 points, got {improvement} for {ability}")
...
class HealCharacterCommand:
    ...
    def __post_init__(self):
        ...
        valid_healing_types = ["natural", "magical", "potion", "spell", "ability", "other"]
...
class DamageCharacterCommand:
    ...
    def __post_init__(self):
        ...
        valid_damage_types = ["physical", "magical", "poison", "fire", "cold", "acid", "lightning", "psychic", "necrotic", "radiant", "other"]
