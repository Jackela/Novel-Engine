...
from ..value_objects import (
    TurnConfiguration, PhaseType, PhaseStatus, PhaseStatusEnum
)
...
class PipelineOrchestrator:
    ...
    def monitor_execution_progress(self, turn_id: UUID) -> Dict[str, Any]:
        ...
        return {
            ...
            'estimated_remaining_seconds': remaining_time.total_seconds() if remaining_time else None,
    ...
    def _prepare_phase_context(
        ...
        return {
            ...
            'previous_phases': [
                p.value for p in turn.get_completed_phases()
            ],
    ...
    def _complete_turn_execution(self, execution_id: UUID, success: bool) -> None:
        ...
        self.execution_metrics['average_execution_time_ms'] = (
            (current_avg * (total_turns - 1) + execution_time) / total_turns
        )
