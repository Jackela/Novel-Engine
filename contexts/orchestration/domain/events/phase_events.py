...
class PhaseCompleted:
    ...
    @staticmethod
    def _calculate_ai_efficiency(events_processed: int, ai_usage: Optional[Dict[str, Any]]) -> float:
...
class PhaseFailed:
    ...
    def create(
        ...
        failure_impact = {
            ...
            'estimated_recovery_time_ms': cls._estimate_recovery_time(phase_type, compensation_priority),
