...
from ..value_objects import (
    TurnId, TurnConfiguration, PhaseStatus, PhaseType, PhaseStatusEnum,
    PipelineResult, PhaseResult, CompensationAction, CompensationType
)
...
class Turn:
    ...
    def __post_init__(self):
        ...
        self._record_audit_event('turn_created', {
    ...
    def start_planning(self) -> None:
        ...
        self._record_audit_event('state_transition', {
        ...
        self._generate_domain_event('TurnPlanningStarted', {
    ...
    def start_execution(self) -> None:
        ...
        self._record_audit_event('execution_started', {
        ...
        # Generate domain event
        self._generate_domain_event('TurnExecutionStarted', {
            'turn_id': self.turn_id.turn_uuid,
            'started_at': self.started_at,
            'first_phase': first_phase.value,
            'estimated_completion': (
                self.started_at + timedelta(
    ...
    def complete_phase(
        ...
        self._record_audit_event('phase_completed', {
        ...
        # Generate domain event
        self._generate_domain_event('PhaseCompleted', {
            'turn_id': self.turn_id.turn_uuid,
    ...
    def fail_phase(
        ...
        # Generate domain event
        self._generate_domain_event('PhaseFailed', {
            'turn_id': self.turn_id.turn_uuid,
            'phase_type': phase_type.value,
            'error_message': error_message,
    ...
    def _initiate_compensation(
        ...
        for phase_name in reversed(committed_phases):  # Reverse order compensation
            for compensation_type in compensation_types:
                if self._should_apply_compensation(phase_name, compensation_type):
                    ...
                    self.saga_state['pending_compensations'].append(str(compensation_action.action_id))
        
        # Record compensation initiation
        self._record_audit_event('compensation_initiated', {
        ...
        # Generate domain event
        self._generate_domain_event('CompensationInitiated', {
            'turn_id': self.turn_id.turn_uuid,
            'failed_phase': failed_phase.value,
    ...
    def complete_compensation_action(
        ...
        self._record_audit_event('compensation_completed', {
            'action_id': str(action_id),
            'compensation_type': completed_action.compensation_type.value,
            'target_phase': completed_action.target_phase,
            'execution_time_ms': completed_action.get_execution_time().total_seconds() * 1000 if completed_action.get_execution_time() else None,
    ...
    def _complete_compensation(self) -> None:
        ...
        # Record compensation completion
        self._record_audit_event('compensation_completed_all', {
        ...
        # Generate domain event
        self._generate_domain_event('TurnCompensationCompleted', {
            'turn_id': self.turn_id.turn_uuid,
    ...
    def _complete_turn_successfully(self) -> None:
        ...
        self._record_audit_event('turn_completed_successfully', {
            'completed_at': self.completed_at.isoformat(),
        ...
        # Generate domain event
        self._generate_domain_event('TurnCompleted', {
            'turn_id': self.turn_id.turn_uuid,
            'completed_at': self.completed_at,
    ...
    def _fail_turn_permanently(
        ...
        total_execution_time = (
            ...
            if self.started_at else timedelta(seconds=0)
        )
        ...
        error_summary = {
            ...
            'error_details': error_details or {},
            'failed_phases': [
                r.phase_type.value for r in phase_results 
        ...
        # Record failure
        self._record_audit_event('turn_failed_permanently', {
        ...
        # Generate domain event
        self._generate_domain_event('TurnFailed', {
            'turn_id': self.turn_id.turn_uuid,
    ...
    def _start_next_phase(self, phase_type: PhaseType) -> None:
        ...
        # Generate domain event
        self._generate_domain_event('PhaseStarted', {
            'turn_id': self.turn_id.turn_uuid,
            'phase_type': phase_type.value,
            'started_at': datetime.now()
        })
    ...
    def get_completed_phases(self) -> List[PhaseType]:
        ...
        return [
            phase_type for phase_type, status in self.phase_statuses.items()
    ...
    def get_pending_compensations(self) -> List[CompensationAction]:
        ...
        return [
            action for action in self.compensation_actions
