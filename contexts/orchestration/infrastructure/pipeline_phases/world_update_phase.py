...
class WorldUpdatePhase(BasePhaseImplementation):
    ...
    async def _validate_world_consistency(
        ...
        context.record_performance_metric('consistency_issues_found', float(len(consistency_issues)))
        context.record_performance_metric('consistency_score', consistency_response.get('score', 1.0))
