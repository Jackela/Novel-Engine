...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler('orchestration.log') if os.environ.get('LOG_FILE') else logging.NullHandler()
    ]
)
...
def main():
    ...
    logger.info(f"Configuration: host={host}, port={port}, log_level={log_level}, reload={reload}, workers={workers}")
