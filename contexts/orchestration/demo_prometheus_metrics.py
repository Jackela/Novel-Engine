...
def demonstrate_core_kpis():
    ...
    passed_checks = sum(core_kpi_checks.values()) + sum(value_checks.values()) + sum(phase_checks.values())
    ...
    for line in metrics_lines:
        if any(keyword in line for keyword in ['novel_engine_llm_cost', 'novel_engine_turn_duration', 'novel_engine_turns_total']):
