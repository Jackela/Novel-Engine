    ...
    async def _test_platform_structure(self) -> None:
        ...
        for dir_path in required_dirs:
            ...
            test_result["tests"].append({
                ...
                "passed": dir_exists,
                "details": f"Platform component directory"
            })
    ...
    def _generate_report(self) -> Dict[str, Any]:
        ...
        for component in self.results:
            ...
            component_summary[name] = {
                ...
                "status": "healthy" if passed == total else "degraded" if passed > 0 else "unhealthy"
            }
...
async def main():
    ...
    try:
        ...
        print(f"Tests: {report['summary']['tests_passed']}/{report['summary']['total_tests']} passed")
