...
class BrowserAutomationService(IBrowserAutomation):
    ...
    async def _execute_ui_test_steps(
        ...
        try:
            ...
            assertions_success_rate = results["assertions_passed"] / max(results["total_assertions"], 1)
            ...
            if results["performance_metrics"]:
                ...
                load_time_score = 1.0 if perf_metrics.get("load_time_ms", 0) < self.performance_thresholds["load_time_ms"] else 0.5
    ...
    async def _measure_performance(self, page: Page, page_url: str) -> PerformanceMetrics:
        ...
        dom_content_loaded_ms = performance_timing["domContentLoadedEventEnd"] - performance_timing["navigationStart"]
