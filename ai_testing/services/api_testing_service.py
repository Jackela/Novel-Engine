...
class APITestExecutor:
    ...
    async def _execute_functional_tests(
        self, request: APITestRequest, endpoints: List[APIEndpoint], context: TestContext
    ) -> List[APITestResult]:
    ...
    async def _execute_load_tests(
            ...
            for endpoint in endpoints:
                for req_num in range(requests_per_user):
                    ...
                    task = self._load_test_single_request(
                        request.base_url, endpoint, auth_headers, delay, user_id, req_num
                    )
        ...
        for endpoint_path, endpoint_results in endpoint_aggregates.items():
            if endpoint_results:
                ...
                success_rate = len([r for r in endpoint_results if r.status_validation]) / len(
                    endpoint_results
                )
    ...
    def _validate_response(self, response: httpx.Response, endpoint: APIEndpoint) -> Dict[str, Any]:
...
class APITestingService(IAPITesting):
    ...
    async def execute_api_test(self, api_spec: APITestSpec, context: TestContext) -> TestResult:
        ...
        try:
            ...
            endpoint_result = (
                suite_result.endpoint_results[0] if suite_result.endpoint_results else None
            )
            ...
            return TestResult(
                ...
                performance_metrics={
                    ...
                    "response_size_bytes": endpoint_result.response_size_bytes
                    if endpoint_result
                    else 0,
                },
    ...
    async def test_api_performance(
        ...
        endpoint_config = {"path": endpoint_url, "method": method, "expected_status": 200}
        ...
        return {
            ...
            "requests_per_second": suite_result.total_endpoints / test_duration_seconds
    ...
    async def validate_api_contract(
        ...
        for endpoint_spec in endpoints:
            ...
            try:
                ...
                test_request = APITestRequest(
                    test_type=APITestType.CONTRACT, base_url=base_url, endpoints=[endpoint_config]
                )
        ...
        try:
                ...
                async with httpx.AsyncClient(timeout=30.0) as client:
                    ...
                    while (time.time() - session_start) < duration_seconds:
                        ...
                        try:
                            ...
                            request_time = (time.time() - request_start) * 1000
                            session_results.append(
                                {"success": False, "response_time": request_time, "error": str(e)}
                            )
            ...
            if all_requests:
                ...
                results["requests_per_second"] = (
                    results["total_requests"] / total_duration if total_duration > 0 else 0
                )
