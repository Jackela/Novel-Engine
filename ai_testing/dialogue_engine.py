...
class CharacterVoice:
    ...
    def _build_emotional_modifiers(self) -> Dict[str, Dict[str, str]]:
        ...
        return {
            "contemplative": {"prefix": "沉思片刻后，", "suffix": "...这值得深思。", "tone": "缓慢而深沉"},
            "excited": {"prefix": "突然，", "suffix": "！", "tone": "急促而激动"},
            "worried": {"prefix": "有些不安地，", "suffix": "...我担心可能...", "tone": "犹豫而紧张"},
            "determined": {"prefix": "坚定地，", "suffix": "。没有退路了。", "tone": "果断而有力"},
            "curious": {"prefix": "好奇地，", "suffix": "...这是什么意思？", "tone": "探询而期待"},
        }
...
class ContextAwareDialogueEngine:
    ...
    def generate_reaction(
        self, reactor_name: str, speaker_name: str, previous_dialogue: str, plot_context: Dict
    ) -> str:
