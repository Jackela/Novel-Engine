...
def run_comprehensive_test():
    ...
    for iteration in range(3):
        ...
        print(f"  Character Balance: {list(evaluation['enhanced_metrics']['character_balance'].values())}")
    ...
    criteria = {
        ...
        "Consistent Performance": all(t['overall_score'] > 75 for t in results['tests'])
    }
