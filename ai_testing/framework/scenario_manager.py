...
class AIScenarioGenerator:
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.max_scenarios_per_request = config.get("scenario_generation", {}).get("max_per_request", 10)
    ...
    async def generate_ai_quality_scenarios(
        ...
        quality_focus: List[QualityMetric] = None
    ) -> List[TestScenario]:
        ...
        try:
            ...
            for scenario_data in scenarios_data:
                scenario = TestScenario(
                    ...
                    quality_thresholds={
                        QualityMetric(k): v 
                        for k, v in scenario_data.get("config", {}).get("quality_thresholds", {}).items()
    ...
    def _generate_template_scenarios(
        ...
        scenarios.append(TestScenario(
            ...
            expected_outcomes=["Simulation completes", "Story generated", "Valid response structure"]
        ))
...
class ScenarioManager:
    ...
    async def create_scenario(
        ...
        **kwargs
        ...
        # Emit creation event
        await self.event_bus.publish("scenario_created", {
