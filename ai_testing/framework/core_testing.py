...
class AITestingFramework:
    ...
    async def _execute_performance_test(
        ...
        metrics.add_assertion_result(
            "load_time", load_time_passed, {"threshold_ms": max_load_time, "actual_ms": load_time}
        )
    ...
    def _calculate_quality_trends(self) -> Dict[str, float]:
        ...
        return {
            metric.value: statistics.mean(scores) for metric, scores in quality_by_metric.items()
        }
