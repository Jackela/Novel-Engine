...
class ObservabilityServer:
    ...
    def _setup_logging(self):
        ...
        self.structured_logger = setup_structured_logging(
            logging_config, "observability-server"
        )
    ...
    def _setup_dashboard_data(self):
        ...
        dashboard_config = DashboardConfig(
            ...
            export_path=self.config.get(
                "dashboard_export_path", "data/dashboard_exports"
            ),
        )
        ...
        async def get_observability_status():
            ...
            status = {
                ...
                "components": {
                    "metrics": {
                        "status": "healthy",
                        "details": "Prometheus metrics active",
                    },
        ...
        while True:
            try:
                if self.dashboard_collector:
                    ...
                    for metric_name, metric_list in current_metrics.get(
                        "metrics", {}
                    ).items():
                        if metric_list:
                    ...
                    if self.alert_manager:
                        for metric_name, metric_list in current_metrics.get(
                            ...
                            if metric_list:
                                ...
                                self.alert_manager.update_metric(
