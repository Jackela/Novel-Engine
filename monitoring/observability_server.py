...
from .alerting import AlertManager, NotificationConfig, create_default_alert_rules
...
from .synthetic_monitoring import (
    SyntheticMonitor,
...
class ObservabilityServer:
    ...
    def _setup_logging(self):
        ...
        self.structured_logger = setup_structured_logging(logging_config, "observability-server")
    ...
    def _setup_synthetic_monitoring(self):
        ...
        health_check = create_http_check(
            name="api_health", url=f"{base_url}/health", expected_status=200, interval=60.0
        )
        ...
        async def get_observability_status():
            ...
            status = {
                ...
                "components": {
                    ...
                    "dashboards": {
                        "status": "healthy" if self.dashboard_collector else "unavailable"
                    },
