...
@contextmanager
def trace_operation(
    operation_name: str, attributes: Dict[str, Any] = None, record_exception: bool = True
):
...
def trace_character_interaction(interaction_type: str):
    ...
    return trace_function(
        ...
        attributes={"interaction.type": interaction_type, "component": "character_interaction"},
        record_parameters=True,
    )
