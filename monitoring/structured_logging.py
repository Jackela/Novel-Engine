...
class StructuredLogger:
    ...
    def _setup_file_handlers(self, formatter):
        ...
        main_handler = logging.handlers.RotatingFileHandler(
            main_log_path, maxBytes=self.config.max_file_size, backupCount=self.config.backup_count
        )
    ...
    def log_business_event(
        ...
        **kwargs,
        ...
        """Log business event"""
        context = {"event_type": event_type, "user_id": user_id, **(business_context or {})}
