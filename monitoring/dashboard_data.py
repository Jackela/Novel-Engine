...
class DashboardDataCollector:
    ...
    def __init__(self, config: DashboardConfig):
        ...
        self.aggregated_data: Dict[str, Dict[str, TimeSeriesData]] = {}  # interval -> metric -> data
    ...
    def get_metric_data(self, metric_name: str, time_range: str = "1h") -> Optional[TimeSeriesData]:
    ...
    async def _aggregate_data(self):
        ...
        for interval in self.config.aggregation_intervals:
            ...
            for metric_name, series in self.time_series_data.items():
                ...
                await self._aggregate_metric_for_interval(series, aggregated_series, interval, current_time)
    ...
    async def _aggregate_metric_for_interval(
        ...
        relevant_points = [
            point for point in raw_series.data_points 
        ...
        executive_dashboard = Dashboard(
            ...
            widgets=[
                ...
                DashboardWidget(
                    ...
                    widget_type="table",
                    metric_queries=["story_generation_requests_total", "story_generation_success_rate"],
                    time_range="24h"
                )
            ]
        )
        ...
        operational_dashboard = Dashboard(
            ...
            widgets=[
                DashboardWidget(
                    ...
                    time_range="1h",
                    config={"chart_type": "area", "thresholds": {"warning": 70, "critical": 90}}
                ),
                DashboardWidget(
                    id="memory_usage",
                    title="Memory Usage",
                    ...
                    time_range="1h",
                    config={"chart_type": "area", "thresholds": {"warning": 80, "critical": 95}}
                ),
                DashboardWidget(
                    id="disk_usage",
                    title="Disk Usage",
                    ...
                    config={"max_value": 100, "thresholds": {"warning": 85, "critical": 95}}
                ),
                DashboardWidget(
                    id="network_io",
                    title="Network I/O",
        ...
        performance_dashboard = Dashboard(
            ...
            widgets=[
                DashboardWidget(
                    ...
                    time_range="1h",
                    config={"chart_type": "line", "aggregation": "percentile", "percentiles": [50, 95, 99]}
                ),
                DashboardWidget(
                    id="throughput",
                ...
                DashboardWidget(
                    ...
                    time_range="1h",
                    config={"chart_type": "line", "aggregation": "percentile", "percentiles": [50, 95]}
                ),
                DashboardWidget(
                    id="cache_hit_rate",
                    ...
                    config={"max_value": 100, "thresholds": {"good": 80, "warning": 60}}
                ),
                DashboardWidget(
    ...
    def export_dashboard_data(self, dashboard_id: str, format: str = "json") -> Optional[str]:
...
def initialize_dashboard_collector(config: Optional[DashboardConfig] = None) -> DashboardDataCollector:
