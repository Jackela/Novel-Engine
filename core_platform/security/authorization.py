...
from .authentication import User, Role, Permission, UserRole, RolePermission, get_auth_service
        ...
        try:
            with get_db_session() as session:
                ...
                default_permissions = [
                    ...
                    ("character.create", ResourceType.CHARACTER.value, ActionType.CREATE.value, "Create characters"),
                    ("character.read", ResourceType.CHARACTER.value, ActionType.READ.value, "View characters"),
                    ("character.update", ResourceType.CHARACTER.value, ActionType.UPDATE.value, "Update characters"),
                    ("character.delete", ResourceType.CHARACTER.value, ActionType.DELETE.value, "Delete characters"),
                    ("character.admin", ResourceType.CHARACTER.value, ActionType.ADMIN.value, "Administer all characters"),
                    
                    # Story permissions
                    ("story.create", ResourceType.STORY.value, ActionType.CREATE.value, "Create stories"),
                    ("story.read", ResourceType.STORY.value, ActionType.READ.value, "View stories"),
                    ("story.update", ResourceType.STORY.value, ActionType.UPDATE.value, "Update stories"),
                    ("story.delete", ResourceType.STORY.value, ActionType.DELETE.value, "Delete stories"),
                    ("story.admin", ResourceType.STORY.value, ActionType.ADMIN.value, "Administer all stories"),
                    
                    # Campaign permissions
                    ("campaign.create", ResourceType.CAMPAIGN.value, ActionType.CREATE.value, "Create campaigns"),
                    ("campaign.read", ResourceType.CAMPAIGN.value, ActionType.READ.value, "View campaigns"),
                    ("campaign.update", ResourceType.CAMPAIGN.value, ActionType.UPDATE.value, "Update campaigns"),
                    ("campaign.delete", ResourceType.CAMPAIGN.value, ActionType.DELETE.value, "Delete campaigns"),
                    ("campaign.admin", ResourceType.CAMPAIGN.value, ActionType.ADMIN.value, "Administer all campaigns"),
                    
                    # User management permissions
                    ("user.create", ResourceType.USER.value, ActionType.CREATE.value, "Create users"),
                    ("user.read", ResourceType.USER.value, ActionType.READ.value, "View users"),
                    ("user.update", ResourceType.USER.value, ActionType.UPDATE.value, "Update users"),
                    ("user.delete", ResourceType.USER.value, ActionType.DELETE.value, "Delete users"),
                    ("user.admin", ResourceType.USER.value, ActionType.ADMIN.value, "Administer all users"),
                    
                    # System permissions
                    ("system.admin", ResourceType.SYSTEM.value, ActionType.ADMIN.value, "System administration"),
                    ("system.monitor", ResourceType.SYSTEM.value, ActionType.READ.value, "Monitor system health"),
                    ("analytics.read", ResourceType.ANALYTICS.value, ActionType.READ.value, "View analytics"),
                ]
                ...
                default_roles = [
                    (SystemRole.SUPER_ADMIN.value, "Super Administrator with all permissions", True),
                    (SystemRole.ADMIN.value, "Administrator with most permissions", True),
                    (SystemRole.MODERATOR.value, "Moderator with content management permissions", True),
                    (SystemRole.USER.value, "Regular user with basic permissions", True),
                ...
                role_permissions = {
                    SystemRole.SUPER_ADMIN.value: [
                        "character.admin", "story.admin", "campaign.admin",
                        "user.admin", "system.admin", "analytics.read"
                    ],
                    SystemRole.ADMIN.value: [
                        "character.admin", "story.admin", "campaign.admin",
                        "user.read", "user.update", "system.monitor", "analytics.read"
                    ],
                    SystemRole.MODERATOR.value: [
                        "character.create", "character.read", "character.update",
                    ...
                    SystemRole.GUEST.value: [
                        "character.read", "story.read", "campaign.read"
                    ]
                }
