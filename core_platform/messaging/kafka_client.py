...
try:
    ...
    class KafkaConnectionError(Exception): pass
    class KafkaTimeoutError(Exception): pass
    class AIOKafkaProducer:
        def __init__(self, *args, **kwargs): pass
        async def start(self): pass
        async def stop(self): pass
        async def send(self, topic, value=None, key=None): pass
    ...
    def create_ssl_context(): return None
