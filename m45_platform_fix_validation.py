...
def test_no_import_conflicts():
    ...
    try:
        ...
        world_model_path = project_root / "contexts/world/infrastructure/projections/world_read_model.py"
        spec = importlib.util.spec_from_file_location("world_read_model", world_model_path)
