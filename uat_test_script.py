...
class StoryForgeUATester:
    ...
    def run_test(self, test_id: str, test_name: str, category: str, 
                 description: str, expected_status: int,
                 method: str = "GET", endpoint: str = "/", **request_kwargs) -> UATestResult:
    ...
    def run_happy_path_tests(self) -> None:
        ...
        self.run_test(
            "HP01", "Root Endpoint Access", "happy_path",
        ...
        self.run_test(
            "HP03", "Character Listing", "happy_path",
    ...
    def run_sad_path_tests(self) -> None:
        ...
        self.run_test(
            "SP01", "Nonexistent Endpoint", "sad_path",
        ...
        self.run_test(
            "SP04", "Invalid Narrative Style", "sad_path",
            "User tries to use invalid narrative style",
            422, "POST", "/simulations",
            json={
                "character_names": ["pilot", "engineer"],
                "turns": 3,
        ...
        self.run_test(
            "SP05", "Insufficient Characters", "sad_path",
        ...
        self.run_test(
            "SP06", "Invalid Turns Count", "sad_path",
        ...
        # SP07: Malformed JSON
        self.run_test(
            "SP07", "Malformed Request", "sad_path",
    ...
    def run_edge_case_tests(self) -> None:
        ...
        self.run_test(
            "EC01", "Minimum Boundary Test", "edge_case",
        ...
        self.run_test(
            "EC02", "Maximum Boundary Test", "edge_case",
        ...
        self.run_test(
            "EC03", "Empty Request Body", "edge_case",
        ...
        self.run_test(
            "EC04", "Wrong HTTP Method", "edge_case",
        ...
        self.run_test(
            "EC05", "Case Sensitivity", "edge_case",
            "User tries to access character with different case",
            404, "GET", "/characters/PILOT"
        )
...
def main():
    ...
    try:
        ...
        failed_or_error = len([r for r in tester.results if r.status in ["FAIL", "ERROR"]])
