...
def test_world_router_import():
    ...
    try:
        ...
        print("✅ World router imported successfully")
        ...
        if len(found_endpoints) == len(expected_endpoints):
            ...
            print(
                f"❌ Missing endpoints: {set(expected_endpoints) - set(found_endpoints)}"
            )
            return False
...
def test_character_domain_direct():
    ...
    try:
        ...
        print(
            f"   - Health: {character.stats.vital_stats.current_health}/{character.stats.vital_stats.max_health}"
        )
        ...
        print(
            f"✅ Damage applied: {original_health} -> {character.stats.vital_stats.current_health}"
        )
