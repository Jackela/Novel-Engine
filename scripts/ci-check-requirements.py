...
DEV_DEPS = {
    'bandit', 'black', 'coverage', 'flake8', 'import-linter', 'isort',
    'mkdocs', 'mkdocs-material', 'mkdocstrings', 'mypy', 'pre-commit',
    'pytest', 'pytest-asyncio', 'pytest-cov', 'pytest-timeout', 'safety',
    # test-specific deps
    'pytest-benchmark', 'pytest-html', 'pytest-mock', 'pytest-xdist',
}
...
def main():
    ...
    if not check_consistency("requirements.txt", req_file, pyproject_deps, is_main=True):
        all_passed = False
