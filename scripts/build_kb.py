        ...
        try:
            ...
            if self.config and self.config.get("legal", {}).get("compliance_mode") == "fan":
                ...
                if not registry_path.exists():
                    ...
                    template_registry = {
                        "sources": [],
                        "compliance": {"non_commercial": True, "distribution": "local_only"},
                    }
    ...
    def build_kb(self) -> bool:
        ...
        try:
            ...
            kb_structure = {
                ...
                "templates": {"narrative_templates.yaml": self._create_narrative_templates()},
            }
...
def main():
    ...
    parser.add_argument(
        "--validate-only", action="store_true", help="Only run validation checks, do not build KB"
    )
    parser.add_argument(
        "--force-build", action="store_true", help="Force KB rebuild even if validation fails"
    )
