...
from src.bridge.llm_coordinator import LLMCoordinator
...
class TestBridgeConfiguration:
    ...
    def test_default_configuration(self):
        ...
        assert config.enable_advanced_coordination == True
        assert config.enable_smart_batching == True
        assert config.enable_dialogue_system == True
    ...
    def test_custom_configuration(self):
        ...
        assert config.enable_advanced_coordination == False
...
class TestEnhancedMultiAgentBridge:
    ...
    def test_bridge_initialization(self, enhanced_bridge):
        ...
        assert enhanced_bridge._initialized == False
    ...
    async def test_bridge_component_initialization(self, enhanced_bridge):
        ...
        with patch('enhanced_multi_agent_bridge_refactored.DialogueManager'):
            with patch('enhanced_multi_agent_bridge_refactored.LLMCoordinator'):
                ...
                assert success == True
                assert enhanced_bridge._initialized == True
    ...
    @pytest.mark.asyncio
    async def test_enhanced_turn_execution_with_agents(self, enhanced_bridge, mock_director_agent):
        ...
        with patch('enhanced_multi_agent_bridge_refactored.DialogueManager'):
            with patch('enhanced_multi_agent_bridge_refactored.LLMCoordinator'):
                with patch('enhanced_multi_agent_bridge_refactored.AIIntelligenceOrchestrator'):
                    with patch('enhanced_multi_agent_bridge_refactored.AgentCoordinationEngine'):
                        await enhanced_bridge.initialize()
    ...
    def test_request_priority_determination(self, enhanced_bridge):
        ...
        priority = enhanced_bridge._determine_request_priority(mock_agent, context_with_dialogues)
        ...
        priority = enhanced_bridge._determine_request_priority(mock_critical_agent, context)
        assert priority == RequestPriority.HIGH
    ...
    async def test_bridge_shutdown(self, enhanced_bridge):
        ...
        assert enhanced_bridge._shutdown_requested == True
    ...
    async def test_context_building(self, enhanced_bridge, mock_director_agent):
        ...
        enhanced_bridge.dialogue_manager.get_agent_dialogues = AsyncMock(return_value=[])
...
class TestBridgeFactory:
    ...
    async def test_create_enhanced_bridge_failure(self):
        ...
        with patch('enhanced_multi_agent_bridge_refactored.EnhancedMultiAgentBridge') as MockBridge:
            mock_instance = Mock()
            mock_instance.initialize = AsyncMock(return_value=False)  # Fail initialization
...
class TestBridgeIntegration:
    ...
    async def test_dialogue_manager_integration(self):
        ...
        # Mock dialogue manager
        with patch('enhanced_multi_agent_bridge_refactored.DialogueManager') as MockDialogueManager:
            mock_dialogue = Mock()
