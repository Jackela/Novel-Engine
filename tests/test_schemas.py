...
try:
    from src.shared_types import (
        # Enums
        ActionType, EntityType, ValidationResult, FogOfWarChannel, SimulationPhase, ActionIntensity,
...
class TestEnumTypes:
    ...
    def test_action_type_values(self):
        ...
        expected_actions = [
            "move", "attack", "defend", "communicate", "observe",
            "use_item", "special_ability", "wait", "retreat", "fortify"
        ]
    ...
    def test_entity_type_values(self):
        ...
        expected_entities = [
            "character", "object", "location", "event", "resource", "structure"
        ]
    ...
    def test_validation_result_values(self):
        ...
        expected_results = ["valid", "invalid", "requires_repair", "catastrophic_failure"]
    ...
    def test_simulation_phase_values(self):
        ...
        expected_phases = [
            "initialization", "planning", "execution", "resolution", "cleanup", "completed"
        ]
...
class TestCharacterTypes:
    ...
    def test_character_stats_validation(self):
        ...
        with pytest.raises(ValueError):
            CharacterStats(
                strength=0,  # Too low
                dexterity=5, intelligence=5, willpower=5, perception=5, charisma=5
            )
        
        with pytest.raises(ValueError):
            CharacterStats(
                strength=5, dexterity=11,  # Too high
                intelligence=5, willpower=5, perception=5, charisma=5
            )
    ...
    def test_character_data_full_creation(self):
        ...
        stats = CharacterStats(
            strength=7, dexterity=6, intelligence=5,
            willpower=9, perception=6, charisma=4
        )
        health = ResourceValue(current=100.0, maximum=100.0)
...
class TestPerformanceTypes:
    ...
    def test_cache_entry_expiration(self):
        ...
        entry_with_ttl = CacheEntry(key="temp", value="data", ttl_seconds=0.001)
...
class TestJSONSerialization:
    ...
    def test_character_data_json_roundtrip(self):
        ...
        json_string = json.dumps(json_data, default=str)  # Handle datetime serialization
        ...
        assert reconstructed.resources.health.current == original.resources.health.current
