...
class TestCreateKnowledgeEntryUseCase:
    ...
    def use_case(self, mock_repository, mock_event_publisher):
        ...
        if CreateKnowledgeEntryUseCase is None:
            pytest.skip("CreateKnowledgeEntryUseCase not yet implemented (TDD - expected to fail)")
    ...
    def valid_command(self):
        ...
        if CreateKnowledgeEntryCommand is None:
            pytest.skip("CreateKnowledgeEntryCommand not yet implemented (TDD - expected to fail)")
    ...
    @pytest.mark.asyncio
    async def test_create_entry_success(self, use_case, valid_command, mock_repository, mock_event_publisher):
    ...
    @pytest.mark.asyncio
    async def test_create_entry_sets_timestamps(self, use_case, valid_command, mock_repository):
    ...
    @pytest.mark.asyncio
    async def test_create_entry_generates_unique_id(self, use_case, valid_command, mock_repository):
    ...
    @pytest.mark.asyncio
    async def test_create_entry_publishes_domain_event(self, use_case, valid_command, mock_event_publisher):
