...
class TestModelCapabilityEnum:
    ...
    def test_all_model_capabilities_exist(self):
        ...
        expected_capabilities = {
            'TEXT_GENERATION', 'CODE_GENERATION', 'CONVERSATION', 'SUMMARIZATION',
            'TRANSLATION', 'ANALYSIS', 'CREATIVE_WRITING', 'FUNCTION_CALLING',
            'VISION', 'EMBEDDING'
        }
...
class TestProviderIdValidation:
    ...
    def test_invalid_provider_name_length_raises_errors(self):
        ...
        # Too short
        with pytest.raises(ValueError, match="provider_name must be 2-100 characters long"):
    ...
    def test_invalid_provider_name_characters_raise_errors(self):
        ...
        with pytest.raises(ValueError, match="provider_name contains invalid characters"):
            ProviderId(provider_name="Invalid@Name!", provider_type=ProviderType.CUSTOM)
        
        with pytest.raises(ValueError, match="provider_name contains invalid characters"):
            ProviderId(provider_name="Name<with>brackets", provider_type=ProviderType.CUSTOM)
    ...
    def test_valid_provider_name_characters(self):
        ...
        for name in valid_names:
            provider_id = ProviderId(provider_name=name, provider_type=ProviderType.CUSTOM)
    ...
    def test_invalid_provider_type_raises_error(self):
        ...
        with pytest.raises(ValueError, match="provider_type must be a ProviderType enum"):
    ...
    def test_invalid_region_code_raises_errors(self):
        ...
        # Wrong length
        with pytest.raises(ValueError, match="region must be a 2-character ISO country code"):
            ProviderId(
                provider_name="Test",
                provider_type=ProviderType.CUSTOM,
                region="USA"  # Too long
...
class TestProviderIdMethods:
    ...
    def test_is_official_provider(self):
        ...
        official_types = [
            ...
            ProviderType.MICROSOFT, ProviderType.AMAZON, ProviderType.COHERE
        ]
...
class TestModelIdValidation:
    ...
    def test_invalid_model_name_length_raises_errors(self):
        ...
        # Too long
        long_name = "a" * 201
        with pytest.raises(ValueError, match="model_name must be 1-200 characters long"):
    ...
    def test_invalid_provider_id_raises_error(self):
        ...
        with pytest.raises(ValueError, match="provider_id must be a ProviderId instance"):
    ...
    def test_invalid_costs_raise_errors(self):
        ...
        # Negative input cost
        with pytest.raises(ValueError, match="cost_per_input_token must be a non-negative Decimal"):
            ModelId(
                model_name="test",
                provider_id=self.provider_id,
        ...
        with pytest.raises(ValueError, match="cost_per_output_token must be a non-negative Decimal"):
            ModelId(
                model_name="test",
                provider_id=self.provider_id,
    ...
    def test_invalid_capabilities_raise_error(self):
        ...
        with pytest.raises(ValueError, match="All capabilities must be ModelCapability enum values"):
            ModelId(
                model_name="test",
                provider_id=self.provider_id,
                capabilities={"text_generation", "invalid_capability"}  # Strings instead of enums
            )
...
class TestModelIdMethods:
    ...
    def test_estimate_cost(self):
        ...
        expected_cost = Decimal('1000') * Decimal('0.00001') + Decimal('500') * Decimal('0.00002')
...
class TestTokenBudgetValidation:
    ...
    def test_invalid_token_values_raise_errors(self):
        ...
        with pytest.raises(ValueError, match="allocated_tokens must be a positive integer"):
        ...
        with pytest.raises(ValueError, match="consumed_tokens must be a non-negative integer"):
            TokenBudget(budget_id="test", allocated_tokens=1000, consumed_tokens=-100)
        
        # Negative reserved tokens
        with pytest.raises(ValueError, match="reserved_tokens must be a non-negative integer"):
    ...
    def test_invalid_cost_values_raise_errors(self):
        ...
        # Negative cost limit
        with pytest.raises(ValueError, match="cost_limit must be a non-negative Decimal"):
            TokenBudget(
                budget_id="test",
                allocated_tokens=1000,
        ...
        with pytest.raises(ValueError, match="accumulated_cost must be a non-negative Decimal"):
            TokenBudget(
                budget_id="test",
                allocated_tokens=1000,
        ...
        with pytest.raises(ValueError, match="accumulated_cost cannot exceed cost_limit"):
            TokenBudget(
                budget_id="test",
                allocated_tokens=1000,
                cost_limit=Decimal('100.00'),
...
class TestTokenBudgetFactoryMethods:
    ...
    def test_create_project_budget(self):
        ...
        budget = TokenBudget.create_project_budget("proj789", 100000, Decimal('1000.00'))
...
class TestTokenBudgetMethods:
    ...
    def test_reserve_tokens_insufficient_budget(self):
        ...
        with pytest.raises(ValueError, match="Cannot reserve 2000 tokens - insufficient budget"):
    ...
    def test_consume_tokens_exceeds_cost_limit(self):
        ...
        with pytest.raises(ValueError, match="Cannot afford additional cost of .* - exceeds cost limit"):
    ...
    def test_is_near_exhaustion(self):
        ...
        assert budget1.is_near_exhaustion(Decimal('40.00')) is True  # Custom threshold (50% > 40%)
