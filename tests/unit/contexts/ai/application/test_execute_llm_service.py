...
from contexts.ai.application.services.execute_llm_service import (
    ExecuteLLMService, LLMExecutionConfig, LLMExecutionResult, ProviderRouter
)
...
class TestProviderRouter:
    ...
    def test_select_provider_for_model_with_fallback(self):
        ...
        self.router._provider_health[self.provider_id_1.provider_name]['consecutive_failures'] = 5
    ...
    def test_can_handle_model_true(self):
        ...
        result = self.router._can_handle_model(self.mock_provider_1, self.model_id_1.model_name)
        
        assert result is True
        self.mock_provider_1.get_model_info.assert_called_once_with(self.model_id_1.model_name)
    ...
    def test_is_provider_healthy_false_not_available(self):
        ...
        self.router.register_provider(self.mock_provider_1)
        self.router._provider_health[self.provider_id_1.provider_name]['available'] = False
...
class TestExecuteLLMServiceExecution:
    ...
    async def test_execute_async_with_exception(self):
        ...
        self.mock_retry_policy.execute_with_retry_async.side_effect = RuntimeError("Provider error")
...
class TestExecuteLLMServiceStatisticsAndMetrics:
    ...
    def test_estimate_request_cost_with_model_pricing(self):
        ...
        expected_cost = Decimal('6') * Decimal('0.00003') + Decimal('100') * Decimal('0.00006')
    ...
    def test_estimate_request_cost_no_max_tokens(self):
        ...
        expected_cost = Decimal(str(input_tokens)) * Decimal('0.00003') + Decimal('100') * Decimal('0.00006')
        assert estimated_cost == expected_cost
...
class TestExecuteLLMServiceIntegration:
    ...
    async def test_error_handling_and_statistics(self):
        ...
        self.mock_provider.generate_async.side_effect = RuntimeError("Provider connection failed")
