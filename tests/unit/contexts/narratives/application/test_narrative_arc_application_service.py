...
from contexts.narratives.application.commands.narrative_arc_commands import (
    CreateNarrativeArcCommand, UpdateNarrativeArcCommand, StartNarrativeArcCommand,
    CompleteNarrativeArcCommand, AddPlotPointCommand, UpdatePlotPointCommand,
    RemovePlotPointCommand, AddThemeCommand, DevelopThemeCommand,
    AddPacingSegmentCommand, AddNarrativeContextCommand, ActivateContextCommand,
    DeactivateContextCommand, AddCharacterToArcCommand, OptimizeSequenceCommand,
    EstablishCausalLinkCommand
)
from contexts.narratives.application.queries.narrative_arc_queries import (
    GetNarrativeArcQuery, GetPlotPointQuery, GetPlotPointsInSequenceQuery,
    GetThemeQuery, GetThemesAtSequenceQuery, GetNarrativeFlowAnalysisQuery,
    GetCausalAnalysisQuery, GetArcMetricsQuery, GetArcSummaryQuery,
    SearchNarrativeArcsQuery, GetNarrativeArcsByTypeQuery
)
...
class TestNarrativeArcApplicationServiceInitialization:
    ...
    @patch('contexts.narratives.application.services.narrative_arc_application_service.NarrativeFlowService')
    @patch('contexts.narratives.application.services.narrative_arc_application_service.CausalGraphService')
    def test_default_service_initialization(self, mock_causal_service, mock_flow_service):
    ...
    @patch('contexts.narratives.application.services.narrative_arc_application_service.logger')
    def test_initialization_logging(self, mock_logger):
        ...
        mock_logger.info.assert_called_once_with("Narrative Arc Application Service initialized")
...
class TestArcLifecycleManagement:
    ...
    def test_create_narrative_arc_minimal_params(self):
        ...
        self.service.command_handler.handle_create_narrative_arc.return_value = expected_arc_id
        ...
        call_args = self.service.command_handler.handle_create_narrative_arc.call_args[0][0]
    ...
    def test_get_narrative_arc(self):
        ...
        self.service.query_handler.handle_get_narrative_arc.return_value = expected_result
    ...
    def test_update_narrative_arc(self):
        ...
        call_args = self.service.command_handler.handle_update_narrative_arc.call_args[0][0]
    ...
    def test_start_narrative_arc(self):
        ...
        call_args = self.service.command_handler.handle_start_narrative_arc.call_args[0][0]
    ...
    def test_complete_narrative_arc(self):
        ...
        call_args = self.service.command_handler.handle_complete_narrative_arc.call_args[0][0]
...
class TestPlotPointManagement:
    ...
    def test_get_plot_points_in_sequence(self):
        ...
        self.service.query_handler.handle_get_plot_points_in_sequence.return_value = expected_result
        ...
        call_args = self.service.query_handler.handle_get_plot_points_in_sequence.call_args[0][0]
    ...
    def test_update_plot_point(self):
        ...
        call_args = self.service.command_handler.handle_update_plot_point.call_args[0][0]
    ...
    def test_remove_plot_point(self):
        ...
        call_args = self.service.command_handler.handle_remove_plot_point.call_args[0][0]
...
class TestThemeManagement:
    ...
    def test_get_themes_at_sequence(self):
        ...
        self.service.query_handler.handle_get_themes_at_sequence.return_value = expected_result
        
        result = self.service.get_themes_at_sequence(arc_id=arc_id, sequence=sequence)
        
        assert result == expected_result
        
        call_args = self.service.query_handler.handle_get_themes_at_sequence.call_args[0][0]
...
class TestPacingManagement:
    ...
    def test_add_pacing_segment_minimal_params(self):
        ...
        call_args = self.service.command_handler.handle_add_pacing_segment.call_args[0][0]
    ...
    def test_add_pacing_segment_full_params(self):
        ...
        assert call_args.tension_curve == [Decimal('3.0'), Decimal('7.0'), Decimal('9.0'), Decimal('5.0')]
...
class TestContextManagement:
    ...
    def test_add_narrative_context_minimal_params(self):
        ...
        call_args = self.service.command_handler.handle_add_narrative_context.call_args[0][0]
    ...
    def test_deactivate_context(self):
        ...
        call_args = self.service.command_handler.handle_deactivate_context.call_args[0][0]
...
class TestCharacterManagement:
    ...
    def test_add_character_to_arc(self):
        ...
        call_args = self.service.command_handler.handle_add_character_to_arc.call_args[0][0]
...
class TestAnalysisAndOptimization:
    ...
    def test_analyze_narrative_flow(self):
        ...
        self.service.query_handler.handle_get_narrative_flow_analysis.return_value = expected_result
        ...
        call_args = self.service.query_handler.handle_get_narrative_flow_analysis.call_args[0][0]
    ...
    def test_optimize_sequence(self):
        ...
        self.service.command_handler.handle_optimize_sequence.return_value = expected_result
        ...
        call_args = self.service.command_handler.handle_optimize_sequence.call_args[0][0]
    ...
    def test_establish_causal_link(self):
        ...
        call_args = self.service.command_handler.handle_establish_causal_link.call_args[0][0]
    ...
    def test_analyze_causality(self):
        ...
        self.service.query_handler.handle_get_causal_analysis.return_value = expected_result
        ...
        call_args = self.service.query_handler.handle_get_causal_analysis.call_args[0][0]
...
class TestSearchAndDiscovery:
    ...
    def test_search_narrative_arcs_minimal_params(self):
        ...
        self.service.query_handler.handle_search_narrative_arcs.return_value = expected_result
        
        result = self.service.search_narrative_arcs()
        
        assert result == expected_result
        
        call_args = self.service.query_handler.handle_search_narrative_arcs.call_args[0][0]
    ...
    def test_get_arcs_by_type(self):
        ...
        self.service.query_handler.handle_get_narrative_arcs_by_type.return_value = expected_result
        ...
        call_args = self.service.query_handler.handle_get_narrative_arcs_by_type.call_args[0][0]
...
class TestErrorHandling:
    ...
    def test_command_handler_exception_propagation(self):
        ...
        self.service.command_handler.handle_create_narrative_arc.side_effect = ValueError("Invalid arc parameters")
    ...
    def test_query_handler_exception_propagation(self):
        ...
        self.service.query_handler.handle_get_narrative_arc.side_effect = RuntimeError("Database connection failed")
...
class TestIntegrationScenarios:
    ...
    def test_analysis_workflow(self):
        ...
        self.service.query_handler.handle_get_narrative_flow_analysis.return_value = flow_analysis
        self.service.query_handler.handle_get_causal_analysis.return_value = causal_analysis
