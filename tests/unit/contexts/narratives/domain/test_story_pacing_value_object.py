...
class TestPacingTypeEnum:
    ...
    def test_all_pacing_types_exist(self):
        ...
        expected_types = {
            'STEADY', 'ACCELERATING', 'DECELERATING', 'EPISODIC', 
            'CRESCENDO', 'PLATEAU', 'WAVE', 'EXPLOSIVE_START', 
            'SLOW_BURN', 'STACCATO'
        }
...
class TestPacingIntensityEnum:
    ...
    def test_intensity_logical_ordering(self):
        ...
        assert intensity_order[PacingIntensity.BREAKNECK] > intensity_order[PacingIntensity.FAST]
        assert intensity_order[PacingIntensity.FAST] > intensity_order[PacingIntensity.BRISK]
        assert intensity_order[PacingIntensity.BRISK] > intensity_order[PacingIntensity.MODERATE]
        assert intensity_order[PacingIntensity.MODERATE] > intensity_order[PacingIntensity.SLOW]
        assert intensity_order[PacingIntensity.SLOW] > intensity_order[PacingIntensity.GLACIAL]
...
class TestStoryPacingCreation:
    ...
    def test_create_full_story_pacing(self):
        ...
        assert pacing.segment_description == "The final confrontation builds to crescendo"
...
class TestStoryPacingValidation:
    ...
    def test_invalid_sequence_numbers_raise_errors(self):
        ...
        with pytest.raises(ValueError, match="Start sequence must be before end sequence"):
            StoryPacing(
                pacing_id="test",
                pacing_type=PacingType.STEADY,
                base_intensity=PacingIntensity.MODERATE,
    ...
    def test_invalid_scale_values_raise_errors(self):
        ...
        with pytest.raises(ValueError, match="sentence_complexity must be between 1 and 10"):
            StoryPacing(
                pacing_id="test",
                pacing_type=PacingType.STEADY,
                base_intensity=PacingIntensity.MODERATE,
    ...
    def test_invalid_frequency_and_intensity_values_raise_errors(self):
        ...
        with pytest.raises(ValueError, match="Revelation frequency must be between 0 and 1"):
            StoryPacing(
                pacing_id="test",
                pacing_type=PacingType.STEADY,
                base_intensity=PacingIntensity.MODERATE,
        ...
        with pytest.raises(ValueError, match="Cliffhanger intensity must be between 0 and 10"):
            StoryPacing(
                pacing_id="test",
                pacing_type=PacingType.STEADY,
                base_intensity=PacingIntensity.MODERATE,
    ...
    def test_invalid_tension_curve_values_raise_errors(self):
        ...
        with pytest.raises(ValueError, match="Tension curve values must be between 0 and 10"):
            StoryPacing(
                pacing_id="test",
                pacing_type=PacingType.STEADY,
                base_intensity=PacingIntensity.MODERATE,
...
class TestStoryPacingProperties:
    ...
    def test_tension_properties_with_curve(self):
        ...
        tension_values = [Decimal('2.0'), Decimal('5.0'), Decimal('8.0'), Decimal('4.0')]
        pacing = StoryPacing(
    ...
    def test_pacing_complexity_score(self):
        ...
        complex_pacing = StoryPacing(
            ...
            rest_periods=[2, 12],
            tension_curve=[Decimal('1.0'), Decimal('8.0'), Decimal('3.0'), Decimal('9.0')],
...
class TestStoryPacingEdgeCases:
    ...
    def test_complex_tension_curve_interpolation(self):
        ...
        complex_curve = [
            Decimal('1.0'), Decimal('3.0'), Decimal('7.0'), Decimal('9.0'),
            Decimal('5.0'), Decimal('2.0'), Decimal('8.0'), Decimal('4.0')
        ]
