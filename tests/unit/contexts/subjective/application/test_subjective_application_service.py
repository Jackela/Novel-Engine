...
from contexts.subjective.application.services.subjective_application_service import SubjectiveApplicationService
from contexts.subjective.domain.repositories.turn_brief_repository import ITurnBriefRepository
...
from contexts.subjective.domain.value_objects.perception_range import (
    PerceptionCapabilities, PerceptionRange, PerceptionType, VisibilityLevel
)
from contexts.subjective.domain.value_objects.knowledge_level import (
    KnowledgeItem, KnowledgeType, CertaintyLevel, KnowledgeSource
)
from contexts.subjective.domain.value_objects.awareness import (
    AlertnessLevel, AttentionFocus, AwarenessModifier, AwarenessState
)
from contexts.subjective.application.commands.subjective_commands import (
    CreateTurnBriefCommand, UpdatePerceptionCapabilitiesCommand, 
    AddPerceptionCommand, UpdateAwarenessStateCommand
)
from contexts.subjective.application.commands.subjective_command_handlers import (
    SubjectiveCommandHandlerRegistry, EntityNotFoundException, 
    InvalidCommandException, SubjectiveCommandHandlerException
)
...
class TestSubjectiveApplicationServiceInitialization:
    ...
    def test_initialization_with_all_dependencies(self):
        ...
        service = SubjectiveApplicationService(
            ...
            fog_of_war_service=mock_fog_service
        )
    ...
    def test_command_handler_registry_initialization(self):
        ...
        with patch('contexts.subjective.application.services.subjective_application_service.SubjectiveCommandHandlerRegistry') as mock_registry_class:
            mock_registry = Mock()
            ...
            mock_registry_class.assert_called_once_with(mock_repository, mock_fog_service)
...
class TestTurnBriefOperations:
    ...
    def test_create_turn_brief_for_entity_success(self, mock_dependencies, sample_perception_capabilities):
        ...
        mock_dependencies['command_handlers'].handle_create_turn_brief.return_value = expected_id
        ...
        mock_dependencies['command_handlers'].handle_create_turn_brief.assert_called_once()
        call_args = mock_dependencies['command_handlers'].handle_create_turn_brief.call_args[0][0]
    ...
    def test_create_turn_brief_with_minimal_parameters(self, mock_dependencies, sample_perception_capabilities):
    ...
    def test_create_turn_brief_command_handler_exception(self, mock_dependencies, sample_perception_capabilities):
        ...
        service.command_handlers = mock_dependencies['command_handlers']
        mock_dependencies['command_handlers'].handle_create_turn_brief.side_effect = SubjectiveCommandHandlerException("Creation failed")
    ...
    def test_get_turn_brief_by_entity_id_found(self, mock_dependencies):
        ...
        mock_dependencies['repository'].get_by_entity_id.assert_called_once_with("test_entity")
    ...
    def test_get_turn_brief_by_entity_id_not_found(self, mock_dependencies):
        ...
        mock_dependencies['repository'].get_by_entity_id.assert_called_once_with("nonexistent_entity")
    ...
    def test_delete_turn_brief_success(self, mock_dependencies):
        ...
        mock_dependencies['repository'].get_by_entity_id.assert_called_once_with("test_entity")
        mock_dependencies['repository'].delete.assert_called_once_with(mock_turn_brief.turn_brief_id)
    ...
    def test_delete_turn_brief_repository_failure(self, mock_dependencies):
        ...
        mock_turn_brief.turn_brief_id = SubjectiveId.generate()
        mock_dependencies['repository'].get_by_entity_id.return_value = mock_turn_brief
        mock_dependencies['repository'].delete.return_value = False  # Repository delete failed
...
class TestPerceptionOperations:
    ...
    def test_update_perception_capabilities_success(self, mock_dependencies, sample_perception_capabilities):
        ...
        service.command_handlers = mock_dependencies['command_handlers']
        mock_dependencies['command_handlers'].handle_update_perception_capabilities.return_value = None
        ...
        # Verify command was created and handled correctly
        mock_dependencies['command_handlers'].handle_update_perception_capabilities.assert_called_once()
        call_args = mock_dependencies['command_handlers'].handle_update_perception_capabilities.call_args[0][0]
    ...
    def test_update_perception_capabilities_entity_not_found(self, mock_dependencies, sample_perception_capabilities):
        ...
        service.command_handlers = mock_dependencies['command_handlers']
        mock_dependencies['command_handlers'].handle_update_perception_capabilities.side_effect = EntityNotFoundException("Entity not found")
    ...
    def test_add_perception_success(self, mock_dependencies):
        ...
        call_args = mock_dependencies['command_handlers'].handle_add_perception.call_args[0][0]
    ...
    def test_add_perception_entity_not_found(self, mock_dependencies):
        ...
        service.command_handlers = mock_dependencies['command_handlers']
        mock_dependencies['command_handlers'].handle_add_perception.side_effect = EntityNotFoundException("Entity not found")
    ...
    def test_add_perception_invalid_command(self, mock_dependencies):
        ...
        service.command_handlers = mock_dependencies['command_handlers']
        mock_dependencies['command_handlers'].handle_add_perception.side_effect = InvalidCommandException("Invalid distance")
...
class TestAwarenessOperations:
    ...
    def test_update_awareness_state_success(self, mock_dependencies, sample_awareness_state):
        ...
        mock_dependencies['command_handlers'].handle_update_awareness_state.assert_called_once()
...
class TestFogOfWarOperations:
    ...
    def test_update_fog_of_war_success(self, mock_dependencies):
        ...
        service.command_handlers = mock_dependencies['command_handlers']
        mock_dependencies['command_handlers'].handle_update_fog_of_war = Mock(return_value=None)
        
        # Mock the method since it might not be fully loaded
        if not hasattr(service, 'update_fog_of_war'):
            def mock_update_fog_of_war(entity_id, world_positions, environmental_conditions, update_reason="world_state_change"):
        ...
        mock_dependencies['command_handlers'].handle_update_fog_of_war.assert_called_once()
...
class TestErrorHandling:
    ...
    def test_repository_exception_propagation(self, mock_dependencies):
        ...
        mock_dependencies['repository'].get_by_entity_id.side_effect = Exception("Database connection failed")
    ...
    def test_command_handler_exception_propagation(self, mock_dependencies):
        ...
        service.command_handlers = mock_dependencies['command_handlers']
        mock_dependencies['command_handlers'].handle_create_turn_brief.side_effect = SubjectiveCommandHandlerException("Handler error")
    ...
    def test_invalid_parameter_handling(self, mock_dependencies):
        ...
        service.command_handlers = mock_dependencies['command_handlers']
        mock_dependencies['command_handlers'].handle_add_perception.side_effect = InvalidCommandException("Entity ID cannot be None")
...
class TestIntegrationScenarios:
    ...
    def test_entity_lifecycle_scenario(self, mock_dependencies, complete_perception_capabilities):
        ...
        mock_dependencies['command_handlers'].handle_create_turn_brief.return_value = created_id
        mock_dependencies['command_handlers'].handle_update_perception_capabilities.return_value = None
        mock_dependencies['command_handlers'].handle_add_perception.return_value = None
        mock_dependencies['repository'].get_by_entity_id.return_value = mock_turn_brief
        mock_dependencies['repository'].delete.return_value = True
        ...
        updated_capabilities = PerceptionCapabilities(
            perception_ranges={
                ...
                PerceptionType.AUDITORY: complete_perception_capabilities.perception_ranges[PerceptionType.AUDITORY],
                PerceptionType.THERMAL: complete_perception_capabilities.perception_ranges[PerceptionType.THERMAL]
            },
        ...
        assert mock_dependencies['command_handlers'].handle_add_perception.call_count == 3
    ...
    def test_error_recovery_scenario(self, mock_dependencies, complete_perception_capabilities):
        ...
        mock_dependencies['command_handlers'].handle_add_perception.side_effect = SubjectiveCommandHandlerException("Perception validation failed")
        
        with pytest.raises(SubjectiveCommandHandlerException, match="Perception validation failed"):
            service.add_perception(
                entity_id=entity_id,
        ...
        assert mock_dependencies['command_handlers'].handle_add_perception.call_count == 2