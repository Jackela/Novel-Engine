...
class TestKnowledgeBaseValidation:
    ...
    def test_invalid_subject_items_type(self):
        ...
        with pytest.raises(ValueError, match="Knowledge items for subject .* must be a list"):
...
class TestKnowledgeBaseQuerying:
    ...
    def test_get_knowledge_about_with_min_reliability(self, sample_knowledge_base):
        ...
        knowledge = sample_knowledge_base.get_knowledge_about("guard_patrol", min_reliability=0.5)
    ...
    def test_get_knowledge_about_sorting(self, sample_knowledge_base):
        ...
        knowledge = sample_knowledge_base.get_knowledge_about("guard_patrol", min_reliability=0.0)
        
        assert len(knowledge) == 2
        # First item should have higher reliability
        assert knowledge[0].get_reliability_score() > knowledge[1].get_reliability_score()
    ...
    def test_get_most_reliable_knowledge_existing(self, sample_knowledge_base):
        ...
        most_reliable = sample_knowledge_base.get_most_reliable_knowledge("guard_patrol")
    ...
    def test_has_knowledge_about_with_sufficient_certainty(self, sample_knowledge_base):
        ...
        assert sample_knowledge_base.has_knowledge_about("guard_patrol", CertaintyLevel.MINIMAL)
    ...
    def test_has_knowledge_about_nonexistent(self, sample_knowledge_base):
        ...
        assert not sample_knowledge_base.has_knowledge_about("nonexistent", CertaintyLevel.MINIMAL)
...
class TestKnowledgeBaseFiltering:
    ...
    def test_get_subjects_by_type(self, diverse_knowledge_base):
        ...
        tactical_subjects = diverse_knowledge_base.get_subjects_by_type(KnowledgeType.TACTICAL)
        assert tactical_subjects == ["location_a"]
        
        factual_subjects = diverse_knowledge_base.get_subjects_by_type(KnowledgeType.FACTUAL)
        assert factual_subjects == ["location_b"]
        
        personal_subjects = diverse_knowledge_base.get_subjects_by_type(KnowledgeType.PERSONAL)
        assert personal_subjects == ["character_x"]
        
        nonexistent_subjects = diverse_knowledge_base.get_subjects_by_type(KnowledgeType.RUMOR)
    ...
    def test_get_subjects_by_tag(self, diverse_knowledge_base):
        ...
        nonexistent_tag_subjects = diverse_knowledge_base.get_subjects_by_tag("nonexistent")
    ...
    def test_get_knowledge_by_source(self, diverse_knowledge_base):
        ...
        direct_obs_knowledge = diverse_knowledge_base.get_knowledge_by_source(KnowledgeSource.DIRECT_OBSERVATION)
        ...
        historical_knowledge = diverse_knowledge_base.get_knowledge_by_source(KnowledgeSource.HISTORICAL_RECORD)
        assert len(historical_knowledge) == 1
        assert "character_x" in historical_knowledge
        
        nonexistent_source_knowledge = diverse_knowledge_base.get_knowledge_by_source(KnowledgeSource.PSYCHIC_READING)
...
class TestKnowledgeBaseImmutableOperations:
    ...
    def test_add_knowledge_creates_new_instance(self):
        ...
        original_kb = KnowledgeBase(knowledge_items={"original_subject": [original_item]})
    ...
    def test_add_knowledge_to_existing_subject(self):
        ...
        test_knowledge = updated_kb.get_knowledge_about("test_subject", min_reliability=0.0)
        assert len(test_knowledge) == 2
        
        # Original should be unchanged
        original_knowledge = original_kb.get_knowledge_about("test_subject", min_reliability=0.0)
    ...
    def test_update_knowledge_subject_mismatch(self):
        ...
        with pytest.raises(ValueError, match="Updated knowledge item subject must match"):
...
class TestKnowledgeBaseStatistics:
    ...
    def test_get_total_knowledge_count(self):
        ...
        knowledge_items["subject_0"].append(KnowledgeItem(
            subject="subject_0",
            information="Additional info",
            knowledge_type=KnowledgeType.RUMOR,
            certainty_level=CertaintyLevel.LOW,
...
class TestComplexScenarios:
    ...
    def test_intelligence_gathering_scenario(self):
        ...
        assert all_knowledge[0].get_reliability_score() >= all_knowledge[1].get_reliability_score()
        assert all_knowledge[1].get_reliability_score() >= all_knowledge[2].get_reliability_score()
