...
class TestAwarenessStateValidation:
    ...
    def test_modifier_value_out_of_range_positive(self):
        ...
        with pytest.raises(ValueError, match="Modifier value .* must be between -1.0 and 1.0"):
            AwarenessState(
                base_alertness=AlertnessLevel.RELAXED,
                current_alertness=AlertnessLevel.RELAXED,
                attention_focus=AttentionFocus.UNFOCUSED,
    ...
    def test_fatigue_level_negative(self):
        ...
        with pytest.raises(ValueError, match="Fatigue level must be between 0.0 and 1.0"):
            AwarenessState(
                base_alertness=AlertnessLevel.RELAXED,
                current_alertness=AlertnessLevel.RELAXED,
                attention_focus=AttentionFocus.UNFOCUSED,
    ...
    def test_stress_level_negative(self):
        ...
        with pytest.raises(ValueError, match="Stress level must be between 0.0 and 1.0"):
            AwarenessState(
                base_alertness=AlertnessLevel.RELAXED,
                current_alertness=AlertnessLevel.RELAXED,
                attention_focus=AttentionFocus.UNFOCUSED,
    ...
    def test_target_specific_focus_requires_target(self):
        ...
        with pytest.raises(ValueError, match="Target-specific focus requires a focus target"):
            AwarenessState(
                base_alertness=AlertnessLevel.RELAXED,
                current_alertness=AlertnessLevel.RELAXED,
                attention_focus=AttentionFocus.TARGET_SPECIFIC,
...
class TestCalculateEffectiveAlertness:
    ...
    def test_stress_extreme_decreases_alertness(self):
        ...
        assert effective in [AlertnessLevel.RELAXED, AlertnessLevel.ALERT, AlertnessLevel.DROWSY]
    ...
    def test_positive_modifiers_increase_alertness(self):
        ...
        assert effective in [AlertnessLevel.ALERT, AlertnessLevel.VIGILANT, AlertnessLevel.PARANOID]
    ...
    def test_negative_modifiers_decrease_alertness(self):
        ...
        assert effective in [AlertnessLevel.SLEEPING, AlertnessLevel.DROWSY, AlertnessLevel.RELAXED]
    ...
    def test_fear_negative_decreases_alertness(self):
        ...
        assert effective in [AlertnessLevel.DROWSY, AlertnessLevel.RELAXED, AlertnessLevel.SLEEPING]
...
class TestStealthDetection:
    ...
    def test_high_alertness_can_detect_stealth(self):
        ...
        for alertness in [AlertnessLevel.ALERT, AlertnessLevel.VIGILANT, AlertnessLevel.PARANOID]:
            state = AwarenessState(
    ...
    def test_low_alertness_cannot_detect_stealth_normally(self):
        ...
        for alertness in [AlertnessLevel.DROWSY, AlertnessLevel.RELAXED]:
            ...
            assert not state.can_detect_stealth(), f"{alertness} should not detect stealth normally"
...
class TestCombatSurprise:
    ...
    def test_high_alertness_not_surprised(self):
        ...
        for alertness in [AlertnessLevel.ALERT, AlertnessLevel.VIGILANT, AlertnessLevel.PARANOID]:
            ...
            assert not state.is_surprised_by_combat(), f"{alertness} should not be surprised"
...
class TestComplexScenarios:
    ...
    def test_focused_researcher_scenario(self):
        ...
        perception_without_task_penalty = perception_bonus + 0.2  # Add back the task penalty
        assert perception_without_task_penalty > 0.0  # Good base perception
        assert perception_bonus < perception_without_task_penalty  # But reduced due to focus
