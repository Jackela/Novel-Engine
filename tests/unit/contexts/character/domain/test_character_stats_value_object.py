...
class TestCoreAbilities:
    ...
    def test_get_strongest_ability(self):
        ...
        abilities = CoreAbilities(
            strength=15, dexterity=14, constitution=20,  # Highest
            intelligence=12, wisdom=13, charisma=11
        )
    ...
    def test_get_weakest_ability(self):
        ...
        abilities = CoreAbilities(
            strength=15, dexterity=14, constitution=16,
            intelligence=12, wisdom=13, charisma=8  # Lowest
        )
    ...
    def test_get_strongest_weakest_tie_handling(self):
        ...
        abilities = CoreAbilities(
            strength=15, dexterity=15, constitution=15,  # Three-way tie for highest
            intelligence=10, wisdom=10, charisma=10     # Three-way tie for lowest
        )
        
        # Should return one of the tied abilities
        strongest = abilities.get_strongest_ability()
        assert strongest in [AbilityScore.STRENGTH, AbilityScore.DEXTERITY, AbilityScore.CONSTITUTION]
        
        weakest = abilities.get_weakest_ability()
        assert weakest in [AbilityScore.INTELLIGENCE, AbilityScore.WISDOM, AbilityScore.CHARISMA]
...
class TestVitalStats:
    ...
    def test_is_alive_with_health(self):
        ...
        stats = VitalStats(
            max_health=50, current_health=30,
            max_mana=20, current_mana=15,
            max_stamina=30, current_stamina=25,
    ...
    def test_is_alive_without_health(self):
        ...
        stats = VitalStats(
            max_health=50, current_health=0,  # No health
            max_mana=20, current_mana=15,
            max_stamina=30, current_stamina=25,
            armor_class=12, speed=30
        )
    ...
    def test_is_unconscious_at_zero_health(self):
        ...
        stats = VitalStats(
            max_health=50, current_health=0,  # Unconscious
            max_mana=20, current_mana=15,
            max_stamina=30, current_stamina=25,
            armor_class=12, speed=30
        )
    ...
    def test_is_unconscious_with_health(self):
        ...
        stats = VitalStats(
            max_health=50, current_health=1,  # Still alive
            max_mana=20, current_mana=15,
            max_stamina=30, current_stamina=25,
            armor_class=12, speed=30
        )
    ...
    def test_is_healthy_at_full_health(self):
        ...
        stats = VitalStats(
            max_health=50, current_health=50,  # Full health
            max_mana=20, current_mana=15,
            max_stamina=30, current_stamina=25,
            armor_class=12, speed=30
        )
    ...
    def test_is_healthy_not_at_full_health(self):
        ...
        stats = VitalStats(
            max_health=50, current_health=45,  # Not full health
            max_mana=20, current_mana=15,
            max_stamina=30, current_stamina=25,
            armor_class=12, speed=30
        )
    ...
    def test_is_wounded_below_half_health(self):
        ...
        stats = VitalStats(
            max_health=50, current_health=20,  # 40% health
            max_mana=20, current_mana=15,
            max_stamina=30, current_stamina=25,
            armor_class=12, speed=30
        )
    ...
    def test_is_wounded_above_half_health(self):
        ...
        stats = VitalStats(
            max_health=50, current_health=30,  # 60% health
            max_mana=20, current_mana=15,
            max_stamina=30, current_stamina=25,
            armor_class=12, speed=30
        )
    ...
    def test_is_critically_wounded_below_quarter_health(self):
        ...
        stats = VitalStats(
            max_health=50, current_health=10,  # 20% health
            max_mana=20, current_mana=15,
            max_stamina=30, current_stamina=25,
            armor_class=12, speed=30
        )
    ...
    def test_is_critically_wounded_above_quarter_health(self):
        ...
        stats = VitalStats(
            max_health=50, current_health=15,  # 30% health
            max_mana=20, current_mana=15,
            max_stamina=30, current_stamina=25,
            armor_class=12, speed=30
        )
    ...
    def test_health_percentage(self):
        ...
        stats = VitalStats(
            max_health=50, current_health=30,  # 60%
            max_mana=20, current_mana=15,
            max_stamina=30, current_stamina=25,
            armor_class=12, speed=30
        )
    ...
    def test_mana_percentage_with_mana(self):
        ...
        stats = VitalStats(
            max_health=50, current_health=30,
            max_mana=20, current_mana=15,  # 75%
            max_stamina=30, current_stamina=25,
            armor_class=12, speed=30
        )
    ...
    def test_mana_percentage_no_mana(self):
        ...
        stats = VitalStats(
            max_health=50, current_health=30,
            max_mana=0, current_mana=0,  # No mana system
            max_stamina=30, current_stamina=25,
            armor_class=12, speed=30
        )
    ...
    def test_stamina_percentage_with_stamina(self):
        ...
        stats = VitalStats(
            max_health=50, current_health=30,
            max_mana=20, current_mana=15,
            max_stamina=40, current_stamina=20,  # 50%
            armor_class=12, speed=30
        )
    ...
    def test_stamina_percentage_no_stamina(self):
        ...
        stats = VitalStats(
            max_health=50, current_health=30,
            max_mana=20, current_mana=15,
            max_stamina=0, current_stamina=0,  # No stamina system
            armor_class=12, speed=30
        )
    ...
    def test_get_condition_summary_perfect_health(self):
        ...
        stats = VitalStats(
            max_health=50, current_health=50,  # 100%
            max_mana=20, current_mana=15,
            max_stamina=30, current_stamina=25,
            armor_class=12, speed=30
        )
    ...
    def test_get_condition_summary_lightly_wounded(self):
        ...
        stats = VitalStats(
            max_health=50, current_health=40,  # 80%
            max_mana=20, current_mana=15,
            max_stamina=30, current_stamina=25,
            armor_class=12, speed=30
        )
    ...
    def test_get_condition_summary_heavily_wounded(self):
        ...
        stats = VitalStats(
            max_health=50, current_health=20,  # 40%
            max_mana=20, current_mana=15,
            max_stamina=30, current_stamina=25,
            armor_class=12, speed=30
        )
    ...
    def test_get_condition_summary_critically_wounded(self):
        ...
        stats = VitalStats(
            max_health=50, current_health=8,  # 16%
            max_mana=20, current_mana=15,
            max_stamina=30, current_stamina=25,
            armor_class=12, speed=30
        )
    ...
    def test_get_condition_summary_unconscious(self):
        ...
        stats = VitalStats(
            max_health=50, current_health=0,  # 0%
            max_mana=20, current_mana=15,
            max_stamina=30, current_stamina=25,
            armor_class=12, speed=30
        )
...
class TestCombatStats:
    ...
    def test_combat_stats_validation_critical_multiplier_too_low_fails(self):
        ...
        assert "Critical damage multiplier must be between 1.0 and 10.0" in str(exc_info.value)
...
class TestCharacterStats:
    ...
    def sample_vital_stats(self) -> VitalStats:
        ...
        return VitalStats(
            max_health=50, current_health=45,
            max_mana=20, current_mana=15,
            max_stamina=30, current_stamina=25,
            armor_class=12, speed=30
        )
    ...
    @pytest.fixture
    def sample_character_stats(self, sample_core_abilities, sample_vital_stats, sample_combat_stats) -> CharacterStats:
    ...
    def test_character_stats_creation_success(self, sample_core_abilities, sample_vital_stats, sample_combat_stats):
    ...
    def test_character_stats_validation_negative_experience_fails(self, sample_core_abilities, sample_vital_stats, sample_combat_stats):
    ...
    def test_character_stats_validation_negative_skill_points_fails(self, sample_core_abilities, sample_vital_stats, sample_combat_stats):
    ...
    def test_character_stats_validation_experience_too_high_fails(self, sample_core_abilities, sample_vital_stats, sample_combat_stats):
    ...
    def test_character_stats_validation_skill_points_too_high_fails(self, sample_core_abilities, sample_vital_stats, sample_combat_stats):
    ...
    def test_character_stats_boundary_values(self, sample_core_abilities, sample_vital_stats, sample_combat_stats):
    ...
    def test_get_ability_modifier(self, sample_character_stats):
        ...
        assert sample_character_stats.get_ability_modifier(AbilityScore.STRENGTH) == 2  # 15 -> +2
        assert sample_character_stats.get_ability_modifier(AbilityScore.CONSTITUTION) == 3  # 16 -> +3
    ...
    def test_is_alive_when_dead(self, sample_core_abilities, sample_combat_stats):
        ...
        dead_vital_stats = VitalStats(
            max_health=50, current_health=0,  # Dead
            max_mana=20, current_mana=15,
            max_stamina=30, current_stamina=25,
            armor_class=12, speed=30
        )
    ...
    def test_can_cast_spells_without_mana(self, sample_core_abilities, sample_combat_stats):
        """Test can_cast_spells returns False without mana."""
        no_mana_vital_stats = VitalStats(
            max_health=50, current_health=45,
            max_mana=20, current_mana=0,  # No mana
            max_stamina=30, current_stamina=25,
            armor_class=12, speed=30
        )
    ...
    def test_needs_rest_low_mana(self, sample_core_abilities, sample_combat_stats):
        ...
        low_mana_vital_stats = VitalStats(
            max_health=50, current_health=45,
            max_mana=20, current_mana=2,  # 10% mana
            max_stamina=30, current_stamina=25,
            armor_class=12, speed=30
        )
    ...
    def test_needs_rest_low_stamina(self, sample_core_abilities, sample_combat_stats):
        ...
        low_stamina_vital_stats = VitalStats(
            max_health=50, current_health=45,
            max_mana=20, current_mana=15,
            max_stamina=30, current_stamina=4,  # 13% stamina
            armor_class=12, speed=30
        )
    ...
    def test_ability_modifier_calculation_precision(self):
        ...
        for ability_score, expected_modifier in test_cases:
            abilities = CoreAbilities(
                strength=ability_score, dexterity=10, constitution=10,
                intelligence=10, wisdom=10, charisma=10
            )
            
            assert abilities.get_ability_modifier(AbilityScore.STRENGTH) == expected_modifier
    ...
    def test_character_stats_edge_case_combinations(self):
        ...
        high_con_abilities = CoreAbilities(
            strength=10, dexterity=10, constitution=25,  # Very high
            intelligence=10, wisdom=10, charisma=10
        )
        ...
        assert edge_case_stats.get_ability_modifier(AbilityScore.CONSTITUTION) == 7  # 25 -> +7
