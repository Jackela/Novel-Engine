...
from src.ai_intelligence.ai_orchestrator import AISystemConfig, IntelligenceLevel
from src.core.system_orchestrator import OrchestratorConfig, SystemHealth
...
class TestAIIntelligenceIntegration:
    ...
    @pytest.fixture
    def integration_orchestrator(self, temp_database, integration_config, orchestrator_config):
    ...
    @pytest.mark.asyncio
    async def test_integration_startup_traditional_only(self, temp_database, orchestrator_config):
    ...
    @pytest.mark.asyncio
    async def test_character_action_processing_traditional(self, integration_orchestrator):
    ...
    @pytest.mark.asyncio
    async def test_character_action_processing_ai_enhanced(self, integration_orchestrator):
    ...
    async def test_story_generation_traditional(self, integration_orchestrator):
        ...
        result = await orchestrator.generate_story_content(
            prompt="Generate a science fiction story",
            user_id="test_user"
        )
    ...
    async def test_memory_and_cleanup(self, integration_orchestrator):
        ...
        if len(integration_orchestrator.response_times) > 100:
            integration_orchestrator.response_times = integration_orchestrator.response_times[-100:]
...
class TestPerformanceValidation:
    ...
    async def test_resource_utilization(self, temp_database):
        ...
        initial_metrics = await orchestrator._generate_integration_metrics()
