...
class TestEventServiceInitialization:
    ...
    def test_service_initialization_sets_repositories_correctly(
        self, event_repo, rumor_repo
    ):
...
class TestListEvents:
    ...
    async def test_list_events_pagination(self, event_service, event_repo):
        ...
        result = await event_service.list_events(
            world_id="world-1", page=1, page_size=2
        )
        assert result.is_ok
    ...
    async def test_list_events_filter_by_impact_scope(self, event_service, event_repo):
        ...
        result = await event_service.list_events(
            world_id="world-1", impact_scope="local"
        )
        assert result.is_ok
        assert len(result.value.events) == 1
    ...
    async def test_list_events_filter_by_faction_id(self, event_service, event_repo):
        ...
        result = await event_service.list_events(
            world_id="world-1", faction_id="faction-1"
        )
        assert result.is_ok
        assert len(result.value.events) == 1
    ...
    async def test_list_events_filter_by_location_id(self, event_service, event_repo):
        ...
        result = await event_service.list_events(
            world_id="world-1", location_id="loc-1"
        )
        assert result.is_ok
        assert len(result.value.events) == 1
    ...
    @pytest.mark.asyncio
    async def test_list_events_invalid_event_type_filter_ignored(
        self, event_service, event_repo
    ):
        ...
        result = await event_service.list_events(
            world_id="world-1", event_type="invalid_type"
        )
    ...
    @pytest.mark.asyncio
    async def test_list_events_sorting_by_structured_date(
        self, event_service, event_repo
    ):
        ...
        event1 = HistoryEvent(
            ...
            structured_date=WorldCalendar(
                year=1000, month=1, day=1, era_name="First Age"
            ),
        )
        event2 = HistoryEvent(
            id="event-2",
            ...
            location_ids=["loc-1"],
            structured_date=WorldCalendar(
                year=999, month=1, day=1, era_name="First Age"
            ),
        )
        await event_repo.save(event1)
        await event_repo.save(event2)
    ...
    @pytest.mark.asyncio
    async def test_list_events_affected_faction_ids_filter(
        self, event_service, event_repo
    ):
        ...
        result = await event_service.list_events(
            world_id="world-1", faction_id="faction-2"
        )
        assert result.is_ok
        assert len(result.value.events) == 1
...
class TestCreateEvent:
    ...
    async def test_create_event_success(self, event_service, sample_event_data):
        ...
        result = await event_service.create_event(
            world_id="world-1", data=sample_event_data
        )
    ...
    @pytest.mark.asyncio
    async def test_create_event_generates_rumor_when_requested(
        self, event_service, sample_event_data
    ):
    ...
    @pytest.mark.asyncio
    async def test_create_event_invalid_event_type(
        self, event_service, sample_event_data
    ):
    ...
    @pytest.mark.asyncio
    async def test_create_event_invalid_significance(
        self, event_service, sample_event_data
    ):
    ...
    @pytest.mark.asyncio
    async def test_create_event_invalid_impact_scope(
        self, event_service, sample_event_data
    ):
    ...
    async def test_create_event_validates_event(self, event_service, sample_event_data):
        ...
        try:
            ...
            assert (
                ...
                or "cannot be empty" in str(e).lower()
            )

    @pytest.mark.asyncio
    async def test_create_event_persists_event(
        self, event_service, event_repo, sample_event_data
    ):
    ...
    @pytest.mark.asyncio
    async def test_create_event_with_structured_date(
        self, event_service, sample_event_data
    ):
    ...
    @pytest.mark.asyncio
    async def test_create_event_with_impact_scope(
        self, event_service, sample_event_data
    ):
    ...
    @pytest.mark.asyncio
    async def test_create_event_rumor_truth_value_based_on_significance(
        self, event_service, sample_event_data
    ):
...
class TestGetEvent:
    ...
    async def test_get_event_not_found(self, event_service):
        ...
        result = await event_service.get_event(
            event_id="non-existent", world_id="world-1"
        )
        assert result.is_ok
...
class TestExportTimeline:
    ...
    @pytest.mark.asyncio
    async def test_export_timeline_filter_by_event_types(
        self, event_service, event_repo
    ):
