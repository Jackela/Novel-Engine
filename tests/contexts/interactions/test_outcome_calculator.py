...
class TestNegotiationStatusTransitions:
    ...
    def test_advance_to_phase_with_time(self):
        ...
        new_status = status.advance_to_phase(
            NegotiationPhase.PREPARATION, activity_time=new_time
        )
...
class TestProposalResponse:
    ...
    def test_validation_inconsistent_accept(self):
        ...
        with pytest.raises(
            ValueError, match="ACCEPT overall response requires all terms"
        ):
            ProposalResponse(
                response_id=uuid4(),
                proposal_id=uuid4(),
    ...
    def test_validation_inconsistent_reject(self):
        ...
        with pytest.raises(
            ValueError, match="REJECT overall response requires at least one term"
        ):
            ProposalResponse(
                response_id=uuid4(),
                proposal_id=uuid4(),
    ...
    def test_validation_partial_accept(self):
        ...
        with pytest.raises(
            ValueError, match="PARTIAL_ACCEPT requires some but not all"
        ):
            ProposalResponse(
                response_id=uuid4(),
                proposal_id=uuid4(),
    ...
    def test_validation_conditional_accept_without_conditions(self):
        ...
        with pytest.raises(
            ValueError, match="Conditional acceptance must include conditions"
        ):
            ProposalResponse(
                response_id=uuid4(),
                proposal_id=uuid4(),
    ...
    def test_get_accepted_terms(self):
        ...
        response = ProposalResponse.create(
            ...
            term_responses=[
                TermResponse(term_id="term_1", response_type=ResponseType.ACCEPT),
                TermResponse(
                    term_id="term_2", response_type=ResponseType.REJECT, comments="No"
                ),
            ],
        )
    ...
    def test_is_complete_rejection_true(self):
        ...
        response = ProposalResponse.create(
            ...
            term_responses=[
                TermResponse(
                    term_id="term_1", response_type=ResponseType.REJECT, comments="No"
                ),
            ],
        )
    ...
    def test_get_acceptance_percentage(self):
        ...
        response = ProposalResponse.create(
            ...
            term_responses=[
                ...
                TermResponse(term_id="term_2", response_type=ResponseType.ACCEPT),
                TermResponse(
                    term_id="term_3", response_type=ResponseType.REJECT, comments="No"
                ),
                TermResponse(
                    term_id="term_4", response_type=ResponseType.REJECT, comments="No"
                ),
            ],
        )
    ...
    def test_with_updated_term_response(self):
        ...
        assert (
            updated.get_term_response("term_1").response_type
