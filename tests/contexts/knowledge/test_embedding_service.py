...
class TestEmbeddingServiceAdapter:
    ...
    async def test_generate_mock_embedding_different_dimensions(self):
        ...
        adapter_small = EmbeddingServiceAdapter(use_mock=True, model="text-embedding-3-small")
        adapter_large = EmbeddingServiceAdapter(use_mock=True, model="text-embedding-3-large")
...
class TestCachedEmbeddingService:
    ...
    @pytest.mark.asyncio
    async def test_embed_cache_miss(self, cached_service, mock_cache_service, mock_delegate):
    ...
    @pytest.mark.asyncio
    async def test_embed_batch_partial_cache_hits(self, cached_service, mock_cache_service, mock_delegate):
    ...
    @pytest.mark.asyncio
    async def test_embed_batch_no_cache_hits(self, cached_service, mock_cache_service, mock_delegate):
