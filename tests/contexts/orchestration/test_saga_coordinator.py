...
class TestCompensationPlanning:
    ...
    def test_plan_compensation_strategy_success(self, saga_coordinator, sample_turn):
...
class TestCompensationExecution:
    ...
    def test_execute_compensation_action_not_ready(self, saga_coordinator, sample_turn):
    ...
    def test_execute_compensation_by_type_world_state(
        ...
        result = saga_coordinator._execute_compensation_by_type(sample_turn, action, {})
    ...
    def test_execute_compensation_by_type_logging(self, saga_coordinator, sample_turn):
    ...
    def test_execute_compensation_by_type_unknown(self, saga_coordinator, sample_turn):
...
class TestParallelCompensation:
    ...
    def test_coordinate_parallel_compensations_empty(
        ...
        result = saga_coordinator.coordinate_parallel_compensations(sample_turn, [])
...
class TestCompensationStatus:
    ...
    def test_get_compensation_status_no_strategy(self, saga_coordinator):
    ...
    def test_get_compensation_status_with_strategy(self, saga_coordinator, sample_turn):
...
class TestHelperMethods:
    ...
    def test_should_apply_compensation(self, saga_coordinator):
        ...
        result = saga_coordinator._should_apply_compensation(
            PhaseType.WORLD_UPDATE, CompensationType.LOG_FAILURE, {}
        )
    ...
    def test_is_critical_failure_world_update(self, saga_coordinator):
        ...
        result = saga_coordinator._is_critical_failure(PhaseType.WORLD_UPDATE, {})
    ...
    def test_is_critical_failure_event_integration(self, saga_coordinator):
        ...
        result = saga_coordinator._is_critical_failure(PhaseType.EVENT_INTEGRATION, {})
    ...
    def test_is_critical_failure_by_severity(self, saga_coordinator):
        ...
        result = saga_coordinator._is_critical_failure(
            PhaseType.SUBJECTIVE_BRIEF, {"severity": "critical"}
        )
    ...
    def test_is_critical_failure_non_critical(self, saga_coordinator):
        ...
        result = saga_coordinator._is_critical_failure(
            PhaseType.SUBJECTIVE_BRIEF, {"severity": "low"}
        )
    ...
    def test_calculate_compensation_cost_unknown(self, saga_coordinator):
        ...
        cost = saga_coordinator._calculate_compensation_cost(MagicMock(), {})
    ...
    def test_can_retry_action_true(self, saga_coordinator):
        ...
        result = saga_coordinator._can_retry_action(
            MagicMock(), {"error_type": "transient_error"}
        )
    ...
    def test_can_retry_action_false(self, saga_coordinator):
        ...
        result = saga_coordinator._can_retry_action(
            MagicMock(), {"error_type": "permission_denied"}
        )

        assert result is False

    def test_group_actions_for_parallel_execution(self, saga_coordinator):
    ...
    def test_has_critical_failures_true(self, saga_coordinator):
        ...
        actions = [
            MagicMock(
                status="failed", compensation_type=CompensationType.ROLLBACK_WORLD_STATE
            )
        ]
    ...
    def test_has_critical_failures_false(self, saga_coordinator):
        ...
        actions = [
            MagicMock(
                status="completed", compensation_type=CompensationType.LOG_FAILURE
            )
        ]
    ...
    def test_calculate_rollback_completeness_full(self, saga_coordinator):
        ...
        result = saga_coordinator._calculate_rollback_completeness(MagicMock(), actions)
    ...
    def test_check_data_integrity_clean(self, saga_coordinator):
        ...
        violations = saga_coordinator._check_data_integrity(MagicMock(), actions)
