...
class TestCharacterLoading:
    ...
    def test_character_metadata_validation(self):
        ...
        for char_name in GENERIC_CHARACTERS:
            ...
            required_fields = ['name', 'age', 'origin', 'faction', 'rank', 'specialization']
            for field in required_fields:
                assert field in char_info, f"Missing {field} in {char_name} character info"
        ...
        for char_name in GENERIC_CHARACTERS:
            ...
            for md_file in char_dir.glob("*.md"):
                ...
                for term in branded_terms:
                    assert term not in content, f"Branded term '{term}' found in {md_file}"
            ...
            for yaml_file in char_dir.glob("*.yaml"):
                ...
                for term in branded_terms:
                    assert term not in content, f"Branded term '{term}' found in {yaml_file}"
...
class TestCharacterStatistics:
    ...
    def test_combat_stats_validity(self):
        ...
        for char_name in GENERIC_CHARACTERS:
            ...
            required_combat_stats = [
                'marksmanship', 'melee', 'tactics', 
                'leadership', 'endurance', 'pilot'
            ]
    ...
    def test_psychological_profile_validity(self):
        ...
        for char_name in GENERIC_CHARACTERS:
            ...
            required_psych_stats = [
                'loyalty', 'aggression', 'caution', 
                'morale', 'corruption_resistance'
            ]
            
            for stat in required_psych_stats:
                assert stat in psych, f"Missing {stat} in {char_name} psychological profile"
                value = psych[stat]
                assert 1 <= value <= 10, f"Invalid {stat} value {value} for {char_name}"
    ...
    def test_equipment_completeness(self):
        ...
        for char_name in GENERIC_CHARACTERS:
            ...
            equipment = stats['equipment']
            required_equipment = ['primary_weapon', 'secondary_weapon', 'armor', 'special_gear']
...
class TestCharacterFactory:
    ...
    def test_character_creation_validation(self, temp_character_dir):
        ...
        char_data = {
            ...
            "combat_stats": {
                "marksmanship": 5, "melee": 5, "tactics": 5,
                "leadership": 5, "endurance": 5, "pilot": 5
            },
            "psychological_profile": {
                "loyalty": 7, "aggression": 3, "caution": 8,
                "morale": 6, "corruption_resistance": 9
            }
        }
    ...
    def test_character_template_validation(self):
        ...
        for char_name in GENERIC_CHARACTERS:
            ...
            if template_sections is None:
                ...
                assert current_sections == template_sections, \
...
class TestCharacterValidation:
    ...
    def test_character_data_consistency(self):
        ...
        for char_name in GENERIC_CHARACTERS:
            ...
            assert yaml_name in md_content, \
            ...
            assert yaml_faction in md_content, \
    ...
    def test_sci_fi_theme_consistency(self):
        ...
        sci_fi_keywords = [
            "space", "galaxy", "galactic", "stellar", "cosmic", "tech", "system",
            "advanced", "science", "research", "defense", "corps", "facility"
        ]
