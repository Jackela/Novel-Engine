...
SCI_FI_KEYWORDS = [
    "space", "galaxy", "cosmic", "stellar", "technology", "research", 
    "defense", "alliance", "systems", "advanced", "discovery"
]
BANNED_BRAND_TERMS = [
    "emperor", "imperial", "warhammer", "40k", "chaos", "orks",
    "space marines", "astra militarum", "adeptus", "krieg", "grim darkness", "far future"
]
...
class TestChroniclerAgentCore:
        ...
        for style, template_dict in chronicler.narrative_templates.items():
            for template_name, template in template_dict.items():
                ...
                for banned_term in BANNED_BRAND_TERMS:
                    assert banned_term not in template_lower, \
    ...
    def test_faction_descriptions_generic(self):
        ...
        expected_factions = [
            'Galactic Defense Forces', 'Colonial Guard', 'Military Corps',
            'Tech Guild', 'Alliance Forces'
        ]
        
        for faction in expected_factions:
            assert faction in chronicler.faction_descriptions, \
        ...
        for faction in banned_factions:
            assert faction not in chronicler.faction_descriptions, \
    ...
    def test_narrative_style_management(self):
        ...
        assert chronicler.set_narrative_style('sci_fi_dramatic') == True
        assert chronicler.narrative_style == 'sci_fi_dramatic'
        
        # Test invalid style rejection
        assert chronicler.set_narrative_style('grimdark_dramatic') == False
    ...
    def test_campaign_log_parsing(self):
        ...
        try:
            ...
            agent_reg_events = [e for e in events if e.event_type == "agent_registration"]
...
class TestStoryContentQuality:
    ...
    def test_character_integration_in_stories(self, sample_campaign_log):
        ...
        assert "maya" in story_lower or "scientist" in story_lower or "research" in story_lower
    ...
    def test_story_atmosphere_consistency(self, sample_campaign_log):
        ...
        dramatic_indicators = [
            "purpose", "destiny", "conflict", "shadows", "light",
            "universe", "cosmos", "endless", "eternal"
        ]
    ...
    def test_story_readability(self, sample_campaign_log):
        ...
        if sentence_lengths:
            ...
            assert 10 <= avg_length <= 30, f"Average sentence length should be reasonable: {avg_length}"
        ...
        if len(words) > 20:
            ...
            for word, count in word_frequency.items():
                ...
                assert repetition_ratio < 0.1, f"Excessive repetition of word '{word}': {repetition_ratio}"
...
class TestDebrandingValidation:
    ...
    def test_sci_fi_theme_replacement(self):
        ...
        try:
            ...
            sci_fi_themes = [
                "vast expanse", "cosmos", "galaxy", "space",
                "destiny", "conflict", "universe", "stars"
            ]
...
class TestNarrativeStyleAndTone:
    ...
    def test_sci_fi_dramatic_style(self):
        ...
        try:
            ...
            dramatic_elements = [
                "vast", "cosmic", "destiny", "purpose", "conflict",
                "shadows", "light", "eternal", "echo"
            ]
    ...
    def test_tactical_style(self):
        ...
        try:
            ...
            tactical_elements = [
                "strategic", "tactical", "maneuver", "position",
                "objective", "mission", "operation"
            ]
    ...
    def test_philosophical_style(self):
        ...
        try:
            ...
            assert len(story) > 50, "Philosophical style should produce thoughtful content"
...
class TestCharacterIntegration:
    ...
    def test_multiple_character_story_generation(self):
        ...
        try:
            ...
            if "maya" in story_lower or "patel" in story_lower or "scientist" in story_lower:
                character_references += 1
            if "jordan" in story_lower or "kim" in story_lower or "engineer" in story_lower:
                character_references += 1
            
            assert character_references >= 2, "Story should reference multiple characters"
    ...
    def test_character_faction_integration(self):
        ...
        try:
            ...
            faction_elements = [
                "defense", "research", "galactic", "scientific", 
                "institute", "force", "alliance"
            ]
...
class TestTemplateAndPatternSystems:
    ...
    def test_response_template_variety(self):
        ...
        assert len(unique_stories) >= 2, "Stories should have some variation in templates"
    ...
    def test_narrative_opening_templates(self):
        ...
        try:
            ...
            atmospheric_words = [
                "vast", "cosmic", "space", "universe", "galaxy",
                "expanse", "chronicles", "destiny"
            ]
...
class TestPerformanceAndScalability:
    ...
    def test_story_generation_performance(self):
        ...
        try:
            ...
            assert generation_time < 5.0, f"Story generation too slow: {generation_time}s"
