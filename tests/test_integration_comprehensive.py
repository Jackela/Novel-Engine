...
class TestFullSystemIntegration:
    ...
    def test_multi_user_concurrent_simulation(self):
        ...
        with ThreadPoolExecutor(max_workers=3) as executor:
            futures = [
                executor.submit(run_simulation, req) 
        ...
        assert len(set(stories)) >= 2, "Concurrent simulations should produce different stories"
...
class TestAPIBackendIntegration:
    ...
    def test_api_character_loading_backend_integration(self):
        ...
        for char_name in GENERIC_CHARACTERS:
            ...
            assert len(context) > 100, f"Character {char_name} should have substantial context"
    ...
    def test_narrative_style_story_consistency(self):
        ...
        try:
            ...
            for style in styles:
                ...
                assert len(story) > 50, f"Style {style} should produce substantial content"
            
            # Stories should have some variation
            unique_stories = set(stories.values())
            # Allow for some similarity but expect some variation
            assert len(unique_stories) >= 1, "Different styles should produce some variation"
...
class TestMultiComponentWorkflows:
    ...
    def test_performance_multi_component_integration(self):
        ...
        assert total_time < 10.0, f"Full workflow should complete quickly: {total_time}s"
...
class TestPerformanceIntegration:
    ...
    def test_concurrent_api_backend_performance(self):
        ...
        assert success_count >= len(responses) * 0.9, "Most concurrent requests should succeed"
...
class TestErrorPropagationAndRecovery:
    ...
    def test_story_generation_error_handling_integration(self):
        ...
        try:
            ...
            assert isinstance(story, str), "Should produce some story despite corruption"
...
class TestSecurityValidationIntegration:
    ...
    def test_brand_content_validation_integration(self):
        ...
        banned_terms = [
            "warhammer", "40k", "emperor", "imperial", "chaos", "orks",
        ...
        sci_fi_terms = [
            "space", "galaxy", "research", "technology", "discovery",
            "cosmic", "stellar", "advanced", "system"
        ]
