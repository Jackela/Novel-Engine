...
class TestCharacterContextIntegration:
    ...
    async def test_character_application_service_create_character(
        ...
        character_application_service.repository.find_by_name = AsyncMock(
            return_value=[]
        )
    ...
    async def test_character_application_service_duplicate_name_validation(
        ...
        character_application_service.repository.find_by_name = AsyncMock(
            return_value=[existing_character]
        )
    ...
    async def test_character_healing_and_damage(
        ...
        assert (
            character_application_service.command_handlers.handle_command.call_count
            == 2
        )
    ...
    async def test_character_query_operations(
        ...
        character_application_service.repository.find_by_class = AsyncMock(
            return_value=mock_characters
        )
