...
try:
    ...
    from src.agents.persona_agent.data.character_data_manager import CharacterDataManager
    ...
    from src.agents.persona_agent.core.types import CharacterData, DecisionContext, PersonaAgentConfig
    ...
    from src.interactions.interaction_engine_system import (
        ...
        InteractionPriority, InteractionEngineConfig
    )
    ...
    from src.bridges.multi_agent_bridge.enhanced_multi_agent_bridge_modular import EnhancedMultiAgentBridge
    from src.bridges.multi_agent_bridge.coordination.dialogue_manager import DialogueManager
    from src.bridges.multi_agent_bridge.llm_processing.llm_batch_processor import LLMBatchProcessor
    from src.bridges.multi_agent_bridge.performance.cost_tracker import CostTracker
    from src.bridges.multi_agent_bridge.core.types import LLMCoordinationConfig, CommunicationType
    ...
    class MockPersonaAgent:
        def __init__(self, agent_id="test_agent", character_directory=None, config=None):
    ...
    class MockInteractionEngine:
        ...
        async def process_interaction(self, context):
            return type('MockOutcome', (), {
                'success': True, 'interaction_id': context.interaction_id,
...
class TestInteractionEngineModularComponents:
    ...
    def test_interaction_engine_initialization(self):
        ...
        assert engine.config.enable_parallel_processing == True
...
class TestModularComponentIntegration:
    ...
    async def test_full_modular_system_coordination(self):
        ...
        # Create agents
        agent1 = PersonaAgent(
            agent_id="coord_test_001",
            character_directory=None
        )
        agent2 = PersonaAgent(
            agent_id="coord_test_002", 
            character_directory=None
        )
...
class TestModularComponentPerformance:
    ...
    async def test_persona_agent_decision_performance(self):
        ...
        assert total_time < 1.0, f"Performance test failed: {total_time}s for 5 decisions"
    ...
    async def test_interaction_engine_throughput(self):
        ...
        assert total_time < 2.0, f"Throughput test failed: {total_time}s for 10 interactions"
