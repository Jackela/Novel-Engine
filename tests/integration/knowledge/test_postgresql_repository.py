...
class TestPostgreSQLKnowledgeRepositorySave:
    ...
    @pytest.mark.asyncio
    async def test_save_with_empty_content_raises_database_constraint_error(self, repository):
...
class TestPostgreSQLKnowledgeRepositoryRetrieveForAgent:
    ...
    @pytest.mark.asyncio
    async def test_retrieve_for_agent_public_access_returns_all_public_entries(self, repository):
    ...
    @pytest.mark.asyncio
    async def test_retrieve_for_agent_role_based_access_with_multiple_roles(self, repository):
    ...
    @pytest.mark.asyncio
    async def test_retrieve_for_agent_character_specific_access_filters_correctly(self, repository):
    ...
    @pytest.mark.asyncio
    async def test_retrieve_for_agent_returns_empty_list_when_no_access(self, repository):
