...
"""
    ...
    @pytest.mark.asyncio
    async def test_migrate_all_agents_handles_empty_directory(self, migration_adapter):
        """
...
class TestMarkdownMigrationRollback:
    ...
    @pytest.mark.asyncio
    async def test_rollback_without_backup_path_raises_error(self, migration_adapter):
        """
