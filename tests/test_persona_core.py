...
class TestAgentIdentity:
    ...
    def test_agent_identity_defaults(self):
        ...
        identity = AgentIdentity(
            ...
            character_directory="/minimal/path"
        )
...
""")
    ...
    def test_persona_core_initialization(self, persona_core):
        ...
        assert persona_core.identity.character_directory.endswith("test_agent_001") == False  # Uses provided path
        assert persona_core.is_active == False
    ...
    async def test_persona_core_activation(self, persona_core):
        ...
        assert persona_core.is_active == True
