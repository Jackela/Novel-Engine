...
class TestDirectorAgentComponents(unittest.TestCase):
    ...
    def test_error_handler(self):
        ...
        # Test recovery
        recovery_result = handler.handle_error(ValueError("Another test error"), context)
...
class TestDirectorAgentIntegration(unittest.TestCase):
    ...
    def test_director_agent_creation(self):
        ...
        expected_components = [
            "config", "world_state", "agent_lifecycle", "turn_execution",
            "narrative", "logging", "error_handler", "validation"
        ]
    ...
    def test_backward_compatibility_interface(self):
        ...
        director = DirectorAgent(self.event_bus, self.world_state_path, self.campaign_log_path)
    ...
    def test_enhanced_interface_methods(self):
        ...
        self.assertTrue(narrative_context is None or isinstance(narrative_context, dict))
...
class TestSystemResilience(unittest.TestCase):
    ...
    def test_error_recovery(self):
        ...
        self.assertIsInstance(invalid_agent_removal, bool)  # Should return False, not crash
...
def run_compatibility_tests():
    ...
    required_methods = [
        'register_agent', 'remove_agent', 'run_turn', 'get_agent_list',
        'save_world_state', 'log_event', 'close_campaign_log', 'get_simulation_status'
    ]
...
def main():
    ...
    print(f"{'✅' if compatibility_success else '❌'} Backward compatibility tests {'passed' if compatibility_success else 'failed'}")
