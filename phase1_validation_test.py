    ...
    try:
        ...
        try:
            ...
            director = DirectorAgent(
                event_bus=event_bus, campaign_log_path=test_campaign_log
            )
            ...
            assert hasattr(
                director, "run_turn"
            ), "DirectorAgent missing run_turn method"
            assert hasattr(
                director, "save_world_state"
            ), "DirectorAgent missing save_world_state method"
            assert hasattr(
    ...
    try:
        ...
        try:
            ...
            if config and isinstance(config, dict):
                ...
                logger.info(
                    "ℹ️ Configuration loading returned empty/null (may be expected)"
                )
...
def run_all_validation_tests():
    ...
    tests = [
        (
            "DirectorAgent Import & Instantiation",
            test_director_agent_import_and_instantiation,
        ),
        (
            "PersonaAgent Import & Instantiation",
            test_persona_agent_import_and_instantiation,
        ),
